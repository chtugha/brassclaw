...
3. Set up Interactions URL to point to your BrassClaw instance
4. Copy the Application ID and Public Key
5. Store in BrassClaw secrets:

   ```bash
   brassclaw secret set discord_bot_token YOUR_BOT_TOKEN
   ```
...
- Interactions Endpoint URL: `https://your-brassclaw.com/webhook/discord`
...
- Check that `discord_bot_token` is set correctly in BrassClaw secrets.
