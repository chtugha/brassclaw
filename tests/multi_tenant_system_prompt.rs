...
mod tests {
    ...
    async fn seed_identity(db: &Arc<dyn brassclaw::db::Database>, user_id: &str, content: &str) {
    ...
    fn extract_system_prompt(requests: &[Vec<brassclaw_llm::ChatMessage>]) -> Option<String> {
