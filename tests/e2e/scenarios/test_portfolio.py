...
async def test_portfolio_skill_listed(brassclaw_server):
    """The trusted portfolio skill should appear in the skills list API."""
    skills = await _get_skills(brassclaw_server)
...
async def test_portfolio_skill_has_activation_keywords(brassclaw_server):
...
async def test_portfolio_widget_renders_positions(page, brassclaw_server):
    """Pre-seed state.json and verify the portfolio widget renders positions."""
    await _seed_portfolio_state(brassclaw_server)
...
async def test_portfolio_widget_shows_share_button(page, brassclaw_server):
...
async def test_portfolio_share_modal_opens(page, brassclaw_server):
...
async def test_portfolio_share_modal_closes(page, brassclaw_server):
...
async def test_portfolio_widget_no_share_button_without_gains(page, brassclaw_server):
