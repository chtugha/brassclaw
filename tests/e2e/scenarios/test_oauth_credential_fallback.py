...
https://github.com/chtugha/brassclaw/issues/999
...
async def test_oauth_credential_injection_after_gmail_auth(brassclaw_server):
...
async def test_tool_registry_lists_authenticated_extensions(brassclaw_server):
...
async def test_credential_fallback_documented_in_code(brassclaw_server):
