...
async def test_in_progress_attachment_turn_survives_reload(page, brassclaw_server):
    ...
    await _wait_for_in_progress_turn(brassclaw_server, thread_id, timeout=15.0)
