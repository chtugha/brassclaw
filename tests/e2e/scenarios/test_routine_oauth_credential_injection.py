...
async def test_routine_with_oauth_credentials_e2e(page, brassclaw_server):
...
async def test_routine_list_shows_oauth_tools_available(page, brassclaw_server):
...
async def test_oauth_token_accessible_across_execution_contexts(brassclaw_server):
