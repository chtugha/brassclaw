...
async def test_pairing_approve_accepts_thread_id_field(brassclaw_server):
...
async def test_pairing_approve_without_thread_id_still_works(brassclaw_server):
...
async def test_pairing_approve_sends_thread_id(page, brassclaw_server):
...
async def test_pairing_approve_sanitizes_channel_name(brassclaw_server):
