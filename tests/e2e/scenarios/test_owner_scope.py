...
async def test_http_channel_created_routine_is_visible_in_web_routines_tab(
    ...
    await _wait_for_routine(brassclaw_server, routine_name)
...
async def test_http_created_full_job_routine_is_visible_in_web_after_approval(
    ...
    thread_id = await _wait_for_http_thread(brassclaw_server, routine_name)
    pending = await _wait_for_pending_gate(brassclaw_server, thread_id)
    ...
    routine = await _wait_for_routine(brassclaw_server, routine_name)
