...
async fn test_sighup_config_reload_address_change() {
    ...
    // 2. Send SIGHUP to the brassclaw process
    ...
    println!("This test requires a running brassclaw instance to verify actual behavior.");
}

#[tokio::test]
#[ignore] // Requires full brassclaw binary
async fn test_sighup_secret_update_zero_downtime() {
    ...
    //
    // Setup:
    // - Start brassclaw with HTTP_PORT=19002 HTTP_WEBHOOK_SECRET=original-secret
    //
    // Test flow:
...
async fn test_sighup_rollback_on_address_bind_failure() {
    ...
    //
    // Setup:
    // - Start brassclaw with HTTP_PORT=19003 HTTP_WEBHOOK_SECRET=test-secret
    //
    // Test flow:
