...
//! functions from `brassclaw::bootstrap`, ensuring test coverage of the actual
//! escaping/formatting logic rather than a reimplementation.

use std::collections::HashMap;
use tempfile::tempdir;

use brassclaw::bootstrap::{save_bootstrap_env_to, upsert_bootstrap_var_to};
...
fn bootstrap_env_preserves_existing_values() {
    ...
    let initial_vars: &[(&str, &str)] = &[
        ...
        (
            "DATABASE_URL",
            "postgres://user:pass@localhost:5432/brassclaw",
        ),
        ("LLM_BACKEND", "nearai"),
    ...
    assert_eq!(
        ...
        Some("postgres://user:pass@localhost:5432/brassclaw"),
...
fn bootstrap_env_handles_special_characters() {
    ...
    let test_cases: &[(&str, &str)] = &[
        ...
        ("WIN_PATH", r"C:\Users\brassclaw\data"),
