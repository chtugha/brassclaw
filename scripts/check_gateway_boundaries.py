#!/usr/bin/env python3
"""Enforce the brassclaw#2599 gateway platform/feature layering rule.
...
- `crate::channels::web::server::` (retained as a defense-in-depth guard
  after the `server.rs` shim was deleted in brassclaw#2599 stage 6, so any
...
FORBIDDEN_PATTERNS = [
    ...
    # The `server.rs` shim was deleted in brassclaw#2599 stage 6; this
...
# to grow.
#
# Empty as of brassclaw#2599 stage 4b: the `platform/static_files.rs` widget
...
class _Tests(unittest.TestCase):
    ...
    def test_detects_server_shim_back_edge(self) -> None:
        ...
        # brassclaw#2599 stage 6, but this test stays as a guard. If a
