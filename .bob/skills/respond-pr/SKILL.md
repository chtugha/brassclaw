...
name: respond-pr
description: >-
  Respond to PR review comments — triage, plan fixes, implement after
  confirmation, push, and reply to reviewers
metadata:
  user-invocable: true
...
2. Run BrassClaw's quality gate to verify nothing breaks:
   - `cargo fmt`
