...
name: pr-shepherd
description: >-
  Full PR lifecycle — review, fix findings, address comments, quality gate,
  push, CI fix loop, merge
metadata:
  user-invocable: true
...
### BrassClaw-specific checks (always)
...
Run the full BrassClaw shipping checklist:
