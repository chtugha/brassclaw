...
```bash
brassclaw registry install web-search
```
...
After installing the extension, you need to configure your Brave Search API key in BrassClaw. You can do this by running:

```bash
brassclaw tool auth web-search
```
