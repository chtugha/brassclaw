...
The `shell` tool lets the agent execute shell commands on the host system. Because shell access is powerful, BrassClaw applies two layers of protection before any command runs: environment scrubbing and command injection detection.
