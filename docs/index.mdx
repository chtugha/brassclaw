...
BrassClaw is a secure, open-source AI agent framework built in Rust and deployed on NEAR AI Cloud. It enables creating AI agents with access to your tools and services, while keeping your credentials safe and private.
...
<CardGroup cols={3}>
  <Card title="Multi-Channel" icon="message" href="/channels">
    Access BrassClaw via web browser, Telegram, terminal UI, or HTTP webhooks
  </Card>
