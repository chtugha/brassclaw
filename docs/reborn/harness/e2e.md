...
| --- | --- |
| Architecture boundaries | `crates/brassclaw_architecture/tests/reborn_dependency_boundaries.rs` |
| Host runtime facade and outcomes | `crates/brassclaw_host_runtime/tests/host_runtime_contract.rs` |
| Host runtime production composition | `crates/brassclaw_host_runtime/tests/host_runtime_services_contract.rs` |
...
| Events/audit replay | `crates/brassclaw_events/tests/durable_log_contract.rs` and host-runtime durable-event tests |
