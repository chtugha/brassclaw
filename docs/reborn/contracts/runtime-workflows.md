# BrassClaw Reborn runtime workflow ownership contract
...
This prevents a new hidden agent runtime from forming inside `brassclaw_kernel`, `brassclaw_extensions`, or a future conversation crate.
