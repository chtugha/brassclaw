...
Connect BrassClaw to Signal so you can talk to your agent in direct messages.
...
The Signal channel connects BrassClaw to a running [signal-cli](https://github.com/AsamK/signal-cli) HTTP daemon. Before configuring BrassClaw, start signal-cli in daemon mode on your machine.
