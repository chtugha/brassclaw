...
const PRIMITIVES = [
  ...
  },
  {
    ...
    color: COLORS.cyan,
    file: "crates/brassclaw_engine/src/types/step.rs",
  },
  {
    name: "Capability",
    ...
    color: COLORS.accent,
    file: "crates/brassclaw_engine/src/capability/",
  },
  {
    name: "MemoryDoc",
    ...
    file: "crates/brassclaw_engine/src/types/memory.rs",
  },
  {
    name: "Project",
    ...
    color: COLORS.purple,
    file: "crates/brassclaw_engine/src/types/project.rs",
  },
];
...
export const PrimitivesScene: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        crates/brassclaw_engine/ &mdash; replaces ~10 v1 abstractions
      </div>
