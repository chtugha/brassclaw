...
description: Use NEAR AI managed hosting for BrassClaw
---

NEAR AI Cloud offers managed hosting for BrassClaw — zero setup required.

## What is NEAR AI Cloud?

NEAR AI Cloud runs BrassClaw for you on their infrastructure:
...
2. Request BrassClaw access from your NEAR AI dashboard
3. Receive your BrassClaw instance URL and credentials

## Authentication

NEAR AI Cloud uses session token authentication. Your token is automatically injected into the BrassClaw environment.

### For hosting providers

If you're deploying BrassClaw on NEAR AI infrastructure:
...
<CardGroup cols={2}>
  <Card title="Local Install" icon="monitor" href="/install/local">
    Run BrassClaw on your own machine
  </Card>
