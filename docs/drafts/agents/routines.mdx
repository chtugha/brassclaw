...
Routines let BrassClaw take action without a human in the loop. Define a trigger, an action, and optional guardrails — the agent handles the rest automatically.
