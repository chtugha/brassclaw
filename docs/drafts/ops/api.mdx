...
description: Complete endpoint reference for the BrassClaw Web Gateway API
---

The BrassClaw Web Gateway exposes a REST API for all agent operations. All endpoints require bearer token authentication.
...
For remote deployments, replace with your reverse proxy domain (e.g., `https://brassclaw.yourdomain.com`).
