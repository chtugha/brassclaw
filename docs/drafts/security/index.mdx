...
description: BrassClaw's defense-in-depth security architecture
---

Security is BrassClaw's primary differentiator. Your data stays yours through multiple layers of defense.

## Security-First Design

BrassClaw is built with security as a core principle:
...
<Frame>
  <img src="/assets/security-architecture.svg" alt="BrassClaw Security Architecture Diagram" />
</Frame>
...
The security architecture illustrates BrassClaw's **defense in depth** approach with four independent protection layers that data flows through before reaching external services.
...
BrassClaw ships with secure defaults:
...
BrassClaw helps with security compliance:

| Requirement | BrassClaw Feature |
|-------------|-----------------|
