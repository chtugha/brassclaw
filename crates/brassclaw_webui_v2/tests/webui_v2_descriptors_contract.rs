...
use brassclaw_webui_v2::{
    ...
    WEBUI_V2_ROUTE_REJECT_COMPONENT, WEBUI_V2_ROUTE_REJECT_RECIPE,
    WEBUI_V2_ROUTE_REJECT_TOOL_SKILL, WEBUI_V2_ROUTE_REMOVE_EXTENSION,
    WEBUI_V2_ROUTE_REMOVE_SKILL, WEBUI_V2_ROUTE_REQUEST_RECIPE_REVIEW,
    ...
    WEBUI_V2_ROUTE_VALIDATE_TOOL_SKILL, webui_v2_routes,
};
...
fn expected_table() -> Vec<Expected> {
    vec![
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_VALIDATE_RECIPE,
            method: NetworkMethod::Put,
            pattern: "/api/webchat/v2/recipes/{project_id}/{recipe_id}/validate",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(4),
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_REJECT_RECIPE,
            method: NetworkMethod::Put,
            pattern: "/api/webchat/v2/recipes/{project_id}/{recipe_id}/reject",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(4),
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_REQUEST_RECIPE_REVIEW,
            method: NetworkMethod::Put,
            pattern: "/api/webchat/v2/recipes/{project_id}/{recipe_id}/review-request",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(4),
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_VALIDATE_TOOL_SKILL,
            method: NetworkMethod::Put,
            pattern: "/api/webchat/v2/tool-skills/{project_id}/{skill_id}/validate",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(4),
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_REJECT_TOOL_SKILL,
            method: NetworkMethod::Put,
            pattern: "/api/webchat/v2/tool-skills/{project_id}/{skill_id}/reject",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(4),
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_REQUEST_TOOL_SKILL_REVIEW,
            method: NetworkMethod::Put,
            pattern: "/api/webchat/v2/tool-skills/{project_id}/{skill_id}/review-request",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: body_limit_kib(4),
