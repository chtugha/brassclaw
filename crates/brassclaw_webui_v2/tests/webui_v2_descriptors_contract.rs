...
use brassclaw_webui_v2::{
    ...
    WEBUI_V2_ROUTE_DELETE_THREAD, WEBUI_V2_ROUTE_EXPORT_SKILL, WEBUI_V2_ROUTE_FIRE_AUTOMATION_NOW,
    ...
    WEBUI_V2_ROUTE_UPSERT_LLM_PROVIDER, WEBUI_V2_ROUTE_VALIDATE_COMPONENT, webui_v2_routes,
};
...
fn expected_table() -> Vec<Expected> {
    vec![
        ...
        Expected {
            route_id: WEBUI_V2_ROUTE_EXPORT_SKILL,
            method: NetworkMethod::Get,
            pattern: "/api/webchat/v2/skills/{id}/export",
            listener_class: ListenerClass::LocalGateway,
            auth_schemes: &[IngressAuthScheme::BearerToken],
            scope_source: IngressScopeSource::AuthenticatedCaller,
            body_limit: BodyLimitPolicy::NoBody,
