...
use crate::descriptors::{
    ...
    WEBUI_V2_PATTERN_GET_COMPONENT_AUDIT_STATUS, WEBUI_V2_PATTERN_GET_DOCUS,
    WEBUI_V2_PATTERN_GET_INTERCEPTOR_CONFIG, WEBUI_V2_PATTERN_GET_LLM_CONFIG,
    WEBUI_V2_PATTERN_GET_RECIPE, WEBUI_V2_PATTERN_GET_TIMELINE, WEBUI_V2_PATTERN_GET_TOOL_SKILL,
    ...
    WEBUI_V2_PATTERN_LIST_RECIPES, WEBUI_V2_PATTERN_LIST_TOOL_SKILLS, WEBUI_V2_PATTERN_LIST_TOOLS,
    ...
    WEBUI_V2_PATTERN_SETTINGS_COMPONENT, WEBUI_V2_PATTERN_SETTINGS_COMPONENT_GRAPH,
    WEBUI_V2_PATTERN_SETTINGS_CONFIG, WEBUI_V2_PATTERN_SETTINGS_CONFIG_KEY,
    WEBUI_V2_PATTERN_SETTINGS_EXTENSION_CATALOGUES, WEBUI_V2_PATTERN_SETTINGS_EXTENSIONS,
...
pub fn webui_v2_router_with_options(state: WebUiV2State, options: WebUiV2RouteOptions) -> Router {
    let mut router = Router::new()
        ...
        .route(
            ...
            get(handlers::get_settings_component_graph),
        )
        .route(
        ...
        // Catalog component detail. Mounted last: it is the only
        // /api/settings/{a}/{b} wildcard, and every static two-segment
        // settings path above out-prioritises it in axum's matcher.
        .route(
            WEBUI_V2_PATTERN_SETTINGS_COMPONENT,
            get(handlers::get_settings_component),
        );
