...
use crate::descriptors::{
    ...
    WEBUI_V2_PATTERN_EXPORT_SKILL, WEBUI_V2_PATTERN_GET_COMPONENT_AUDIT_STATUS,
    WEBUI_V2_PATTERN_GET_DOCUS, WEBUI_V2_PATTERN_GET_INTERCEPTOR_CONFIG,
    ...
    WEBUI_V2_PATTERN_LIST_CONNECTABLE_CHANNELS, WEBUI_V2_PATTERN_LIST_DOCUS,
    WEBUI_V2_PATTERN_LIST_EXTENSION_REGISTRY, WEBUI_V2_PATTERN_LIST_EXTENSIONS,
    WEBUI_V2_PATTERN_LIST_LLM_MODELS, WEBUI_V2_PATTERN_LIST_PREFIXES,
    WEBUI_V2_PATTERN_LIST_RECIPES, WEBUI_V2_PATTERN_LIST_SKILLS, WEBUI_V2_PATTERN_LIST_TOOL_SKILLS,
    WEBUI_V2_PATTERN_LIST_TOOLS, WEBUI_V2_PATTERN_RE_REVIEW_COMPONENT,
    WEBUI_V2_PATTERN_RECORD_RECIPE_OUTCOME, WEBUI_V2_PATTERN_REGENERATE_PREFIX,
    WEBUI_V2_PATTERN_REJECT_COMPONENT, WEBUI_V2_PATTERN_REMOVE_EXTENSION,
    ...
    WEBUI_V2_PATTERN_SETTINGS_MCP_SERVER_STOP, WEBUI_V2_PATTERN_SETTINGS_MONTY_VM,
    WEBUI_V2_PATTERN_SETTINGS_MONTY_VM_RESTART, WEBUI_V2_PATTERN_SETTINGS_MONTY_VM_STATUS,
    WEBUI_V2_PATTERN_SETTINGS_EXTENSION_CATALOGUES, WEBUI_V2_PATTERN_SETTINGS_ORCHESTRATORS,
    WEBUI_V2_PATTERN_SETTINGS_PYTHON_CODE, WEBUI_V2_PATTERN_SETTINGS_RECIPES,
    WEBUI_V2_PATTERN_SETTINGS_SCAFFOLDS, WEBUI_V2_PATTERN_SETTINGS_SECURITY,
    WEBUI_V2_PATTERN_SETTINGS_SKILLS, WEBUI_V2_PATTERN_SETTINGS_TOOL_SKILLS,
    ...
    WEBUI_V2_PATTERN_UPDATE_TOOL_PERMISSION, WEBUI_V2_PATTERN_VALIDATE_COMPONENT,
...
pub fn webui_v2_router_with_options(state: WebUiV2State, options: WebUiV2RouteOptions) -> Router {
    let mut router = Router::new()
        ...
        .route(WEBUI_V2_PATTERN_LIST_PREFIXES, get(handlers::list_prefixes))
        .route(
            WEBUI_V2_PATTERN_REGENERATE_PREFIX,
            post(handlers::regenerate_prefix),
        )
        // Phase K.1.7 — SKILL.md on-demand export.
        .route(WEBUI_V2_PATTERN_EXPORT_SKILL, get(handlers::export_skill))
        ...
        .route(
            ...
            get(handlers::get_settings_recipes),
        )
        .route(
            WEBUI_V2_PATTERN_SETTINGS_TOOL_SKILLS,
            get(handlers::get_settings_tool_skills),
        )
        .route(
            WEBUI_V2_PATTERN_SETTINGS_PYTHON_CODE,
            get(handlers::get_settings_python_code),
        )
        .route(
            WEBUI_V2_PATTERN_SETTINGS_EXTENSION_CATALOGUES,
            get(handlers::get_settings_extension_catalogues),
        )
        .route(
        ...
        .route(
            ...
            get(handlers::get_settings_security).put(handlers::put_settings_security),
        )
        .route(
        ...
        .route(WEBUI_V2_PATTERN_LIST_DOCUS, get(handlers::list_docus))
        .route(
