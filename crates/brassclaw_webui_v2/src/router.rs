...
use crate::descriptors::{
    ...
    WEBUI_V2_PATTERN_DELETE_COMPONENT, WEBUI_V2_PATTERN_DELETE_LLM_PROVIDER,
    WEBUI_V2_PATTERN_DELETE_THREAD, WEBUI_V2_PATTERN_GET_COMPONENT_AUDIT_STATUS,
    WEBUI_V2_PATTERN_GET_INTERCEPTOR_CONFIG, WEBUI_V2_PATTERN_GET_LLM_CONFIG,
    WEBUI_V2_PATTERN_GET_RECIPE, WEBUI_V2_PATTERN_GET_TIMELINE,
