...
use crate::descriptors::{
    ...
    WEBUI_V2_PATTERN_GET_TOOLS, WEBUI_V2_PATTERN_INSTALL_EXTENSION,
...
pub fn webui_v2_router_with_options(state: WebUiV2State, options: WebUiV2RouteOptions) -> Router {
    let mut router = Router::new()
        ...
        .route(WEBUI_V2_PATTERN_GET_TOOLS, get(handlers::get_tools))
        .route(
            WEBUI_V2_PATTERN_UPDATE_TOOL_PERMISSION,
            axum::routing::put(handlers::update_tool_permission),
        );
