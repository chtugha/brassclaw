...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_GET_LLM_CONFIG, WEBUI_V2_ROUTE_GET_RECIPE, WEBUI_V2_ROUTE_GET_TIMELINE,
    WEBUI_V2_ROUTE_GET_TOOL_SKILL, WEBUI_V2_ROUTE_INSTALL_EXTENSION, WEBUI_V2_ROUTE_INSTALL_SKILL,
    ...
    WEBUI_V2_ROUTE_LIST_VALIDATION_QUEUE, WEBUI_V2_ROUTE_RE_REVIEW_COMPONENT,
    ...
    WEBUI_V2_ROUTE_REMOVE_EXTENSION, WEBUI_V2_ROUTE_REMOVE_SKILL, WEBUI_V2_ROUTE_REQUEST_RECIPE_REVIEW,
    WEBUI_V2_ROUTE_REQUEST_TOOL_SKILL_REVIEW, WEBUI_V2_ROUTE_RESOLVE_GATE,
    ...
    WEBUI_V2_ROUTE_TEST_LLM_CONNECTION, WEBUI_V2_ROUTE_UPDATE_TOOL_PERMISSION,
    WEBUI_V2_ROUTE_UPSERT_LLM_PROVIDER, WEBUI_V2_ROUTE_VALIDATE_COMPONENT,
    WEBUI_V2_ROUTE_VALIDATE_RECIPE, WEBUI_V2_ROUTE_VALIDATE_TOOL_SKILL,
