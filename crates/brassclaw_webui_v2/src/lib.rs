...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_LIST_DOCUS, WEBUI_V2_ROUTE_GET_DOCUS, WEBUI_V2_ROUTE_UPDATE_DOCUS,
    ...
    WEBUI_V2_ROUTE_PUT_SETTINGS_MONTY_VM, WEBUI_V2_ROUTE_GET_SETTINGS_SECURITY,
