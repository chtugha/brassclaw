...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_GET_RECIPE, WEBUI_V2_ROUTE_GET_TIMELINE, WEBUI_V2_ROUTE_GET_TOOL_SKILL,
    ...
    WEBUI_V2_ROUTE_LIST_LLM_MODELS, WEBUI_V2_ROUTE_LIST_RECIPES, WEBUI_V2_ROUTE_LIST_SKILLS,
    WEBUI_V2_ROUTE_LIST_THREADS, WEBUI_V2_ROUTE_LIST_TOOL_SKILLS, WEBUI_V2_ROUTE_LIST_TOOLS,
    WEBUI_V2_ROUTE_LIST_VALIDATION_QUEUE, WEBUI_V2_ROUTE_PREWARM_INTERCEPTOR,
