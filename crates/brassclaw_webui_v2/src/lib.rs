...
pub use descriptors::{
    WEBUI_V2_PATTERN_SETTINGS_RECIPES, WEBUI_V2_ROUTE_ACTIVATE_EXTENSION,
    WEBUI_V2_ROUTE_CANCEL_RUN, WEBUI_V2_ROUTE_COMPLETE_NEARAI_WALLET_LOGIN,
    WEBUI_V2_ROUTE_COUNT_VALIDATION_QUEUE, WEBUI_V2_ROUTE_CREATE_AUTOMATION,
    WEBUI_V2_ROUTE_CREATE_THREAD, WEBUI_V2_ROUTE_DELETE_AUTOMATION,
    WEBUI_V2_ROUTE_DELETE_COMPONENT, WEBUI_V2_ROUTE_DELETE_INTENT_INPUTS,
    WEBUI_V2_ROUTE_DELETE_LLM_PROVIDER, WEBUI_V2_ROUTE_DELETE_THREAD,
    WEBUI_V2_ROUTE_FIRE_AUTOMATION_NOW, WEBUI_V2_ROUTE_GET_AUTOMATION,
    WEBUI_V2_ROUTE_GET_AUTOMATION_RUNS, WEBUI_V2_ROUTE_GET_COMPONENT_AUDIT_STATUS,
    WEBUI_V2_ROUTE_GET_DOCUS, WEBUI_V2_ROUTE_GET_EXTENSION_SETUP,
    ...
    WEBUI_V2_ROUTE_GET_SETTINGS_COMPONENT, WEBUI_V2_ROUTE_GET_SETTINGS_COMPONENT_GRAPH,
    WEBUI_V2_ROUTE_GET_SETTINGS_CONFIG, WEBUI_V2_ROUTE_GET_SETTINGS_EXTENSION_CATALOGUES,
    WEBUI_V2_ROUTE_GET_SETTINGS_EXTENSIONS, WEBUI_V2_ROUTE_GET_SETTINGS_MCP_SERVER,
    WEBUI_V2_ROUTE_GET_SETTINGS_MCP_SERVER_STATUS, WEBUI_V2_ROUTE_GET_SETTINGS_MONTY_VM,
    WEBUI_V2_ROUTE_GET_SETTINGS_MONTY_VM_STATUS, WEBUI_V2_ROUTE_GET_SETTINGS_ORCHESTRATORS,
    WEBUI_V2_ROUTE_GET_SETTINGS_PYTHON_CODE, WEBUI_V2_ROUTE_GET_SETTINGS_RECIPES,
    WEBUI_V2_ROUTE_GET_SETTINGS_SCAFFOLDS, WEBUI_V2_ROUTE_GET_SETTINGS_SECURITY,
    WEBUI_V2_ROUTE_GET_SETTINGS_SKILLS, WEBUI_V2_ROUTE_GET_SETTINGS_TOOL_SKILLS,
    ...
    WEBUI_V2_ROUTE_LIST_CONNECTABLE_CHANNELS, WEBUI_V2_ROUTE_LIST_DOCUS,
    ...
    WEBUI_V2_ROUTE_LIST_PREFIXES, WEBUI_V2_ROUTE_LIST_RECIPES, WEBUI_V2_ROUTE_LIST_THREADS,
    WEBUI_V2_ROUTE_LIST_TOOL_SKILLS, WEBUI_V2_ROUTE_LIST_TOOLS,
    WEBUI_V2_ROUTE_LIST_VALIDATION_QUEUE, WEBUI_V2_ROUTE_POST_SETTINGS_MCP_SERVER_START,
    WEBUI_V2_ROUTE_POST_SETTINGS_MCP_SERVER_STOP, WEBUI_V2_ROUTE_POST_SETTINGS_MONTY_VM_RESTART,
    WEBUI_V2_ROUTE_PUT_CHAT_PREFERENCE, WEBUI_V2_ROUTE_PUT_SETTINGS_CONFIG_KEY,
    WEBUI_V2_ROUTE_PUT_SETTINGS_MCP_SERVER, WEBUI_V2_ROUTE_PUT_SETTINGS_MONTY_VM,
    WEBUI_V2_ROUTE_PUT_SETTINGS_SECURITY, WEBUI_V2_ROUTE_RE_REVIEW_COMPONENT,
    WEBUI_V2_ROUTE_RECORD_RECIPE_OUTCOME, WEBUI_V2_ROUTE_REGENERATE_PREFIX,
    WEBUI_V2_ROUTE_REJECT_COMPONENT, WEBUI_V2_ROUTE_REMOVE_EXTENSION, WEBUI_V2_ROUTE_RESOLVE_GATE,
    WEBUI_V2_ROUTE_SEND_COMPONENT_TO_REVISION, WEBUI_V2_ROUTE_SEND_MESSAGE,
    WEBUI_V2_ROUTE_SET_ACTIVE_LLM, WEBUI_V2_ROUTE_SET_AUTOMATION_STATE,
    ...
    WEBUI_V2_ROUTE_UPDATE_AUTOMATION, WEBUI_V2_ROUTE_UPDATE_DOCUS,
    ...
    WEBUI_V2_ROUTE_VALIDATE_COMPONENT, is_webui_v2_llm_config_route_id, webui_v2_routes,
};
pub use error::{WebUiV2HttpError, WebUiV2HttpErrorBody};
pub use handlers::{
    activate_extension, cancel_run, complete_nearai_wallet_login, create_automation, create_thread,
    delete_automation, delete_llm_provider, delete_thread, fire_automation_now, get_automation,
    get_automation_run_history, get_extension_setup, get_llm_config, get_settings_recipes,
    ...
    resolve_gate, send_message, set_active_llm, set_automation_state, setup_extension,
    start_codex_login, start_nearai_login, stream_events, stream_events_ws, test_llm_connection,
    update_automation, upsert_llm_provider,
};
pub use router::{
