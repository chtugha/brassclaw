...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_LIST_INTENT_INPUTS, WEBUI_V2_ROUTE_LIST_LLM_MODELS, WEBUI_V2_ROUTE_LIST_RECIPES,
    WEBUI_V2_ROUTE_LIST_SKILLS, WEBUI_V2_ROUTE_LIST_THREADS, WEBUI_V2_ROUTE_LIST_TOOL_SKILLS,
    WEBUI_V2_ROUTE_LIST_TOOLS, WEBUI_V2_ROUTE_LIST_VALIDATION_QUEUE,
    WEBUI_V2_ROUTE_POST_SETTINGS_MONTY_VM_RESTART, WEBUI_V2_ROUTE_PREWARM_INTERCEPTOR,
