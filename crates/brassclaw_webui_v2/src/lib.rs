...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_DELETE_LLM_PROVIDER, WEBUI_V2_ROUTE_DELETE_THREAD, WEBUI_V2_ROUTE_EXPORT_SKILL,
    ...
    WEBUI_V2_ROUTE_GET_TIMELINE, WEBUI_V2_ROUTE_GET_TOOL_SKILL, WEBUI_V2_ROUTE_INSTALL_EXTENSION,
    ...
    WEBUI_V2_ROUTE_REJECT_COMPONENT, WEBUI_V2_ROUTE_REMOVE_EXTENSION, WEBUI_V2_ROUTE_REMOVE_SKILL,
    WEBUI_V2_ROUTE_RESOLVE_GATE, WEBUI_V2_ROUTE_SEND_COMPONENT_TO_REVISION,
    WEBUI_V2_ROUTE_SEND_MESSAGE, WEBUI_V2_ROUTE_SET_ACTIVE_LLM,
    WEBUI_V2_ROUTE_SET_AUTOMATION_STATE, WEBUI_V2_ROUTE_SETUP_EXTENSION,
    ...
    WEBUI_V2_ROUTE_TEST_LLM_CONNECTION, WEBUI_V2_ROUTE_UPDATE_AUTOMATION,
    WEBUI_V2_ROUTE_UPDATE_DOCUS, WEBUI_V2_ROUTE_UPDATE_INTERCEPTOR_CONFIG,
