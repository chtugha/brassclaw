...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_GET_SETTINGS_CONFIG, WEBUI_V2_ROUTE_GET_SETTINGS_EXTENSIONS,
    WEBUI_V2_ROUTE_GET_SETTINGS_MCP_SERVER, WEBUI_V2_ROUTE_GET_SETTINGS_MCP_SERVER_STATUS,
    WEBUI_V2_ROUTE_GET_SETTINGS_MONTY_VM, WEBUI_V2_ROUTE_GET_SETTINGS_MONTY_VM_STATUS,
    WEBUI_V2_ROUTE_GET_SETTINGS_ORCHESTRATORS, WEBUI_V2_ROUTE_GET_SETTINGS_RECIPES,
    WEBUI_V2_ROUTE_GET_SETTINGS_SCAFFOLDS, WEBUI_V2_ROUTE_GET_SETTINGS_SECURITY,
    WEBUI_V2_ROUTE_GET_SETTINGS_SKILLS, WEBUI_V2_ROUTE_GET_SETTINGS_TOOLS,
