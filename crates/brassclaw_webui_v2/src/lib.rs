...
pub use descriptors::{
    ...
    WEBUI_V2_ROUTE_LIST_RECIPES, WEBUI_V2_ROUTE_LIST_SKILLS,
    ...
    WEBUI_V2_ROUTE_RE_REVIEW_COMPONENT, WEBUI_V2_ROUTE_REASSEMBLE_INTERCEPTOR,
    WEBUI_V2_ROUTE_RECORD_RECIPE_OUTCOME, WEBUI_V2_ROUTE_REJECT_COMPONENT,
    WEBUI_V2_ROUTE_REJECT_RECIPE, WEBUI_V2_ROUTE_REJECT_TOOL_SKILL,
    WEBUI_V2_ROUTE_REMOVE_EXTENSION, WEBUI_V2_ROUTE_REMOVE_SKILL,
    WEBUI_V2_ROUTE_REQUEST_RECIPE_REVIEW, WEBUI_V2_ROUTE_REQUEST_TOOL_SKILL_REVIEW,
    ...
    WEBUI_V2_ROUTE_VALIDATE_COMPONENT, WEBUI_V2_ROUTE_VALIDATE_RECIPE,
    WEBUI_V2_ROUTE_VALIDATE_TOOL_SKILL, is_webui_v2_llm_config_route_id, webui_v2_routes,
};
