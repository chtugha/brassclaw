...
//! downstream crates can enable `brassclaw_agent_loop/test-support` and drive
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopContextPort for MockAgentLoopDriverHost {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopPromptPort for MockAgentLoopDriverHost {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopInputPort for MockAgentLoopDriverHost {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopModelPort for MockAgentLoopDriverHost {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopCapabilityPort for MockAgentLoopDriverHost {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopTranscriptPort for MockAgentLoopDriverHost {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopCheckpointPort for MockAgentLoopDriverHost {
    async fn checkpoint(
        &self,
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopProgressPort for MockAgentLoopDriverHost {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopCompactionPort for MockAgentLoopDriverHost {
...
impl brassclaw_turns::run_profile::LoopRecipePort for MockAgentLoopDriverHost {
    fn recipe_lookup(&self) -> Option<&dyn brassclaw_turns::run_profile::RecipeLookup> {
        None
    }
}

impl brassclaw_turns::run_profile::LoopRetrievalPort for MockAgentLoopDriverHost {
