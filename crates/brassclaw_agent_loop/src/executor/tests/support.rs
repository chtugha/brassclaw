...
use brassclaw_host_api::{CapabilityId, RuntimeKind, TenantId, ThreadId};
use brassclaw_turns::{
...
pub(super) struct MockHost {
    ...
    batch_outcomes: Arc<Mutex<VecDeque<brassclaw_turns::run_profile::CapabilityBatchOutcome>>>,
    ...
    progress_events: Arc<Mutex<Vec<brassclaw_turns::run_profile::LoopProgressEvent>>>,
...
impl MockHost {
    ...
    pub(super) fn with_batch_outcomes(
        self,
        outcomes: Vec<brassclaw_turns::run_profile::CapabilityBatchOutcome>,
    ) -> Self {
    ...
    pub(super) fn progress_events(&self) -> Vec<brassclaw_turns::run_profile::LoopProgressEvent> {
...
impl brassclaw_turns::run_profile::LoopRunInfoPort for MockHost {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopContextPort for MockHost {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopPromptPort for MockHost {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopInputPort for MockHost {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopModelPort for MockHost {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopCapabilityPort for MockHost {
    async fn visible_capabilities(
        ...
        Ok(VisibleCapabilitySurface {
            ...
            descriptors: vec![CapabilityDescriptorView {
                ...
                concurrency_hint: brassclaw_turns::run_profile::ConcurrencyHint::SafeForParallel,
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopTranscriptPort for MockHost {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopCheckpointPort for MockHost {
    async fn checkpoint(
        &self,
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopProgressPort for MockHost {
    async fn emit_loop_progress(
        &self,
        event: brassclaw_turns::run_profile::LoopProgressEvent,
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopCompactionPort for MockHost {
...
pub(super) fn reply_response_with_text(text: &str) -> LoopModelResponse {
    LoopModelResponse {
        ...
        output: ParentLoopOutput::AssistantReply(brassclaw_turns::run_profile::AssistantReply {
