...
- Use the public executor entry point and real built-in families for behavior
  tests.
- Use `brassclaw_agent_loop::test_support` for host fixtures and scripted model
...
- Do not duplicate `brassclaw_reborn` driver-adapter coverage here.
