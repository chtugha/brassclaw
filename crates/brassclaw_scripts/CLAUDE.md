...
- Keep script-specific execution semantics here. Extension parsing belongs in `brassclaw_extensions`, dispatch selection in `brassclaw_dispatcher`, process lifecycle in `brassclaw_processes`, and product workflow outside this crate.
