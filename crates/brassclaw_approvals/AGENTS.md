...
- Note: the durable approval *request records* are owned by `brassclaw_run_state`; this crate consumes them and produces the lease/denial decision.
...
- Fast local check: `cargo test -p brassclaw_approvals`
