//! Approval resolution service for BrassClaw Reborn.
//!
//! `brassclaw_approvals` resolves durable approval requests and issues scoped
    ...
    L: CapabilityLeaseStore + ?Sized,
{
    ...
    pub async fn deny(
        &self,
        scope: &ResourceScope,
        request_id: brassclaw_host_api::ApprovalRequestId,
        denial: DenyApproval,
    ...
    async fn emit_approval_resolved(
        &self,
        scope: &ResourceScope,
        request: &brassclaw_host_api::ApprovalRequest,
        resolved_by: Principal,
        decision: ApprovalDecisionKind,
    ) {
        self.emit_audit_best_effort(brassclaw_host_api::AuditEnvelope::approval_resolved(
            scope,
            request,
            resolved_by,
            decision,
    ...
    async fn emit_audit_best_effort(&self, record: brassclaw_host_api::AuditEnvelope) {
