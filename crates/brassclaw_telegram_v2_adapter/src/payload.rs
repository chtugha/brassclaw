...
//! `brassclaw_product_adapters` contract that says NoOps must be a
...
fn build_payload(
    ...
    if let Some((command, arguments)) = extract_first_bot_command(&message, policy) {
        ...
        // `brassclaw_product_adapters` validation fires on the
...
mod tests {
    ...
    fn group_mention_with_bot_command_emits_command_payload() {
        ...
        let payload = br#"{
            ...
            "message": {
                ...
                "text": "@brassclaw_bot /help",
                "entities": [
                    {"type": "mention", "offset": 0, "length": 14},
                    {"type": "bot_command", "offset": 15, "length": 5}
                ]
            }
        }"#;
        let parsed =
    ...
    fn command_arguments_with_control_char_rejected_via_shared_validation() {
        ...
        // and the shared `brassclaw_product_adapters` validation
    ...
    fn command_arguments_exceeding_byte_limit_rejected_via_shared_validation() {
        ...
        // per `brassclaw_product_adapters::inbound`) and assert the
    ...
    fn group_media_caption_mention_is_recognized_as_bot_mention() {
        ...
        // `@brassclaw_bot help` carries its mention in
        ...
        let payload = br#"{
            ...
            "message": {
                ...
                "caption": "@brassclaw_bot please look",
    ...
    fn group_explicit_mention_creates_envelope() {
        let payload = br#"{
            ...
            "message": {
                ...
                "from": {"id": 777, "is_bot": false, "first_name": "Alice"},
                "chat": {"id": -42, "type": "supergroup"},
                "text": "@brassclaw_bot please help",
        ...
        let payload = br#"{
            ...
            "message": {
                ...
                "reply_to_message": {
                    "message_id": 7,
                    "date": 1699999999,
                    "from": {"id": 9000, "is_bot": true, "first_name": "BrassClaw"},
                    "chat": {"id": -42, "type": "supergroup"},
                    "text": "hi there"
                }
            }
    ...
    fn group_recognized_command_creates_command_envelope() {
        let payload = br#"{
            ...
            "message": {
                ...
                "from": {"id": 777, "is_bot": false, "first_name": "Alice"},
                "chat": {"id": -42, "type": "supergroup"},
                "text": "/help@brassclaw_bot args here",
