# Agent Map — brassclaw_telegram_v2_adapter
...
- Fast local check: `cargo test -p brassclaw_telegram_v2_adapter`
- Run `cargo test -p brassclaw_product_adapters` when shared DTO assumptions change.
