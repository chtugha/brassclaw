//! Run-state contracts for BrassClaw Reborn.
//!
//! `brassclaw_run_state` stores the current lifecycle state for host-managed
...
//! [`ScopedFilesystem`](brassclaw_filesystem::ScopedFilesystem). The
...
/// tenant/user-scoped [`VirtualPath`](brassclaw_host_api::VirtualPath) per
/// its [`MountView`](brassclaw_host_api::MountView) and enforces per-op ACL
...
/// returns post-resolution [`VirtualPath`](brassclaw_host_api::VirtualPath)s,
...
/// (`crates/brassclaw_run_state/CLAUDE.md`).
///
