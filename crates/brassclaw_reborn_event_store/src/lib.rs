...
//! invocation boundary. Adding it requires changes to `brassclaw_events`,
...
struct TrustedRuntimeJsonlEntry {
    cursor: EventCursor,
    #[serde(deserialize_with = "brassclaw_events::deserialize_trusted_runtime_event")]
    record: RuntimeEvent,
}
...
/// the function returns. Cross-process safe: two BrassClaw processes that race
