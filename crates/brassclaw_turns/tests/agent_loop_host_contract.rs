...
use brassclaw_turns::{
    ...
    run_profile::{
        ...
        InstructionMaterializationStore, InstructionSafetyContext, InterceptorResult,
        ...
        PromptSkillContextMetadata, RecipeLookup, VisibleCapabilityRequest,
...
async fn host_managed_model_port_routes_gateway_and_emits_model_milestones() {
    ...
    gateway.push_response(Ok(LoopModelResponse {
        chunks: vec![brassclaw_turns::run_profile::ModelStreamChunk {
...
impl AgentLoopDriver for ReplyDriver {
    ...
    async fn run(
        &self,
        request: brassclaw_turns::AgentLoopDriverRunRequest,
    ...
    async fn resume(
        &self,
        request: brassclaw_turns::AgentLoopDriverResumeRequest,
        host: &(dyn AgentLoopDriverHost + Send + Sync),
    ) -> Result<LoopExit, AgentLoopDriverError> {
        self.run(
            brassclaw_turns::AgentLoopDriverRunRequest {
...
impl AgentLoopDriver for CapabilityDriver {
    ...
    async fn run(
        &self,
        _request: brassclaw_turns::AgentLoopDriverRunRequest,
        host: &(dyn AgentLoopDriverHost + Send + Sync),
    ) -> Result<LoopExit, AgentLoopDriverError> {
        let surface = host
            .visible_capabilities(VisibleCapabilityRequest)
...
async fn claimed_run_context() -> LoopRunContext {
    let scope = brassclaw_turns::TurnScope::new(
...
fn driver_run_request(host: &RecordingAgentLoopHost) -> brassclaw_turns::AgentLoopDriverRunRequest {
    brassclaw_turns::AgentLoopDriverRunRequest {
        turn_id: host.context.turn_id,
        run_id: host.context.run_id,
