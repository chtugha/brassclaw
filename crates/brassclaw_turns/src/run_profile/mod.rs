...
pub use host::{
    ...
    InterceptorResult, LoopInterruptKind, LoopModelCapabilityView, LoopModelMessage, LoopModelPort,
    ...
    ModelStreamChunk, NoInterceptor,
    NoRecipeLookup, ParentLoopOutput, ProcessHandleSummary, PromptMode, ProviderToolCall,
