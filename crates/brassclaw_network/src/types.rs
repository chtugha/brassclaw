...
use brassclaw_host_api::{NetworkMethod, NetworkPolicy, NetworkTarget, ResourceScope};
...
mod tests {
    use super::*;
    use brassclaw_host_api::{InvocationId, NetworkScheme, NetworkTargetPattern, TenantId, UserId};
