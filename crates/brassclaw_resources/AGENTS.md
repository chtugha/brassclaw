...
- Reservation/receipt vocabulary `ResourceReservation` / `ResourceReceipt`, re-exported from `brassclaw_host_api`.
...
- Fast local check: `cargo test -p brassclaw_resources`
