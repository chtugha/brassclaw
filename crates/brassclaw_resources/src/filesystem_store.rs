...
//! [`MountView`](brassclaw_host_api::MountView) and route every
...
//! [`ScopedFilesystem`](brassclaw_filesystem::ScopedFilesystem) mount
...
/// tenant/user-scoped [`VirtualPath`](brassclaw_host_api::VirtualPath)
/// per its [`MountView`](brassclaw_host_api::MountView) and enforces
