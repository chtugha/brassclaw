//! Composition-only runtime dispatch contracts for BrassClaw Reborn.
//!
//! `brassclaw_dispatcher` wires validated extension descriptors to runtime lanes. It
...
use brassclaw_events::{EventSink, RuntimeEvent};
...
// Removed: dispatch_error_kind was a local copy of DispatchError::event_kind() from brassclaw_host_api.
