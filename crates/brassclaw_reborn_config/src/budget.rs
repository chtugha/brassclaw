//! Resolved cost-based budget defaults for BrassClaw Reborn.
//!
...
pub const ROUTINE_LIGHTWEIGHT_USD_ENV: &str = "BRASSCLAW_BUDGET_ROUTINE_LIGHTWEIGHT_USD";
/// Per-fire budget for standard routines. `0` = unlimited.
pub const ROUTINE_STANDARD_USD_ENV: &str = "BRASSCLAW_BUDGET_ROUTINE_STANDARD_USD";
/// Default per-job budget for one-shot container jobs. `0` = unlimited.
pub const BACKGROUND_JOB_DEFAULT_USD_ENV: &str = "BRASSCLAW_BUDGET_BACKGROUND_JOB_DEFAULT_USD";
/// IANA timezone for calendar-period rollover.
pub const BUDGET_DEFAULT_TZ_ENV: &str = "BRASSCLAW_BUDGET_DEFAULT_TZ";
/// Warn threshold fraction in `[0.0, 1.0]`.
pub const BUDGET_WARN_AT_ENV: &str = "BRASSCLAW_BUDGET_WARN_AT";
/// Pause-with-approval threshold fraction in `[0.0, 1.0]`.
pub const BUDGET_PAUSE_AT_ENV: &str = "BRASSCLAW_BUDGET_PAUSE_AT";
/// Pre-call estimate inflation multiplier.
pub const BUDGET_OVERESTIMATE_FACTOR_ENV: &str = "BRASSCLAW_BUDGET_OVERESTIMATE_FACTOR";
