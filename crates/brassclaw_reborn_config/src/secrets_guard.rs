...
//!
//! Mirrors the epic [#3036](https://github.com/chtugha/brassclaw/issues/3036)
...
//! `~/.brassclaw/reborn/config.toml` instead of pointing at
//! `OPENAI_API_KEY` should be told no, loudly, on the very first
//! `brassclaw-reborn run`. That way the muscle-memory carries straight
