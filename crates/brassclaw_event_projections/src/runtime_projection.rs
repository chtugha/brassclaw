...
use brassclaw_events::{EventLogEntry, RuntimeEvent, RuntimeEventKind, sanitize_error_kind};
...
fn compare_projection_order(
    left_updated_at: &brassclaw_host_api::Timestamp,
    right_updated_at: &brassclaw_host_api::Timestamp,
    left_cursor: brassclaw_events::EventCursor,
    right_cursor: brassclaw_events::EventCursor,
