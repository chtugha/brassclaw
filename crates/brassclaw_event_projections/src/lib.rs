...
//! implementation is replay-derived over [`brassclaw_events::DurableEventLog`]
...
pub use brassclaw_events::EventCursor;
...
pub struct TimelineEntry {
    ...
    pub event_id: brassclaw_events::RuntimeEventId,
