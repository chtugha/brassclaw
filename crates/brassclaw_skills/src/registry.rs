...
pub struct SkillRegistry {
    ...
    /// User skills directory (~/.brassclaw/skills/). Skills here are Trusted.
    user_dir: PathBuf,
    /// Registry-installed skills directory (~/.brassclaw/installed_skills/). Skills here are Installed.
