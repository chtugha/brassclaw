...
pub enum SkillSource {
    ...
    Workspace(PathBuf),
    /// User skills directory (~/.brassclaw/skills/).
    User(PathBuf),
    /// Registry-installed skills directory (~/.brassclaw/installed_skills/).
    Installed(PathBuf),
...
/// here so that `brassclaw_skills` remains independent of the main crate.
