...
function getThemeMode() {
  const stored = localStorage.getItem('brassclaw-theme');
...
function toggleTheme() {
  ...
  localStorage.setItem('brassclaw-theme', next);
  applyTheme(next);
}
...
document.getElementById('settings-theme-toggle')?.addEventListener('click', () => {
  ...
  if (btn) {
    const mode = localStorage.getItem('brassclaw-theme') || 'system';
