...
const I18n = {
  ...
  init() {
    ...
    const savedLang = localStorage.getItem('brassclaw_language');
  ...
  setLanguage(lang) {
    if (this.translations[lang]) {
      ...
      localStorage.setItem('brassclaw_language', lang);
      this.updateHtmlLang();
      this.updatePageContent();
      window.dispatchEvent(new CustomEvent('brassclaw:language-changed', {
        detail: { lang }
      }));
      return true;
    }
