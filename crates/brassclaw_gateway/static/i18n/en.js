// English Language Pack for BrassClaw

I18n.register('en', {
  // Auth Page
  'auth.title': 'BrassClaw',
  ...
  // Restart Modal
  'restart.title': 'Restart BrassClaw Instance',
  'restart.description': 'Are you sure you want to restart BrassClaw? This will gracefully restart the process.',
  ...
  'config.telegramOwnerHint': 'After saving, BrassClaw will show a one-time code. Send `/start CODE` to your bot in Telegram and BrassClaw will finish setup automatically.',
  ...
  'welcome.description': 'BrassClaw is your secure AI assistant. Choose a suggestion below or type your own message.',
