...
I18n.register('zh-CN', {
  ...
  // 重启弹窗
  'restart.title': '重启 BrassClaw 实例',
  'restart.description': '确定要重启 BrassClaw 实例吗？这将优雅地重启进程。',
  'restart.warning': '正在运行的任务可能会中断。重启将在几秒钟内完成。',
  'restart.cancel': '取消',
  'restart.confirm': '确认重启',
  'restart.progressTitle': '正在重启 BrassClaw',
  ...
  'config.telegramOwnerHint': '保存后，BrassClaw 会显示一次性验证码。将 `/start CODE` 发送给你的 Telegram 机器人，BrassClaw 会自动完成设置。',
  ...
  'welcome.description': 'BrassClaw 是您的安全 AI 助手。选择下方的建议或输入您自己的消息。',
