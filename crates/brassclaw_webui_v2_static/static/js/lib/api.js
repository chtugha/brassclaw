...
// `brassclaw_reborn_webui_ingress::webui_v2_auth_router`, or a
...
// `brassclaw_product_workflow::webui_inbound` and
// `brassclaw_product_workflow::reborn_services::types`. The error
// envelope mirrors `RebornServicesError`.

const TOKEN_KEY = "brassclaw_token";
...
// `brassclaw_reborn_webui_ingress` at the same origin as the SPA. The
