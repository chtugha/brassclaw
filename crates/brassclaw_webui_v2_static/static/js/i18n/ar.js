...
registerPack("ar", {
  ...
  "login.console": "وحدة تحكم BrassClaw",
  ...
  "chat.placeholder": "راسل BrassClaw...",
  "chat.send": "إرسال",
  ...
  "settings.toolPermissions": "أذونات الأدوات",
  "settings.skillPackages": "حزم المهارات",
  "settings.actions": "الإجراءات",
  "settings.orchestrator": "المنسِّق",
  "settings.scaffold": "Scaffold",
  "settings.montyVm": "Monty VM",
  "settings.validationQueue": "قائمة التحقق",
  "settings.docs": "مستندات الوكيل",
  "settings.docs.title": "وثائق الوكيل",
  "settings.docs.empty": "لا توجد مستندات",
  "settings.docs.save": "حفظ",
  "settings.docs.source_label": "المصدر",
  "settings.docs.converted_label": "محوّل",
  "settings.docs.failedLoad": "فشل تحميل المستندات: {message}",
  "settings.docs.saveError": "فشل الحفظ: {message}",
  "settings.docs.status.pending": "قيد الانتظار",
  "settings.docs.status.validated": "مُتحقَّق منه",
  "settings.docs.status.rejected": "مرفوض",
  "settings.docs.status.auto_passed": "اجتاز تلقائيًا",

  "settings.reliability": "الموثوقية",
  ...
  "projects.empty.noneDesc": "تظهر المشاريع عندما ينشئ المساعد مساحات عمل دائمة. يمكنك البدء من الدردشة وطلب BrassClaw لإنشاء مشروع محدد النطاق للعمل المستمر.",
  ...
  "chat.heroPlaceholder": "اسأل BrassClaw أي شيء.",
