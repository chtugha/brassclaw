...
registerPack("ja", {
  ...
  "chat.placeholder": "BrassClaw にメッセージ…",
  "chat.send": "送信",
  ...
  "settings.toolPermissions": "ツール権限",
  "settings.tools": "ツール",
  "settings.skills": "スキル",
  "settings.actions": "アクション",
  "settings.orchestrators": "オーケストレーター",
  "settings.scaffolds": "スキャフォールド",
  "settings.montyVm": "Monty VM",
  "settings.validationQueue": "検証キュー",
  "settings.docs": "エージェントドキュメント",
  "settings.docs.title": "エージェントドキュメント",
  "settings.docs.empty": "ドキュメントなし",
  "settings.docs.save": "保存",
  "settings.docs.source_label": "ソース",
  "settings.docs.converted_label": "変換済み",
  "settings.docs.failedLoad": "ドキュメントの読み込みに失敗しました: {message}",
  "settings.docs.saveError": "保存に失敗しました: {message}",
  "settings.docs.status.pending": "保留中",
  "settings.docs.status.validated": "検証済み",
  "settings.docs.status.rejected": "却下",
  "settings.docs.status.auto_passed": "自動承認",

  "settings.reliability": "信頼性",
  "settings.users": "ユーザー",
  ...
  "projects.empty.noneDesc": "アシスタントが永続ワークスペースを作成するとプロジェクトが表示されます。チャットから開始し、継続作業のためのプロジェクト作成をBrassClawに依頼できます。",
  ...
  "chat.heroPlaceholder": "BrassClaw に何でも聞いてください。",
