...
registerPack("es", {
  ...
  "login.console": "Consola BrassClaw",
  ...
  "chat.placeholder": "Mensaje a BrassClaw...",
  ...
  "settings.toolPermissions": "Permisos de herramientas",
  "settings.skillPackages": "Paquetes de skills",
  ...
  "settings.docs": "Documentación del Agente",
  "settings.docs.title": "Documentación del Agente",
  "settings.docs.empty": "Sin documentos",
  "settings.docs.save": "Guardar",
  "settings.docs.source_label": "fuente",
  "settings.docs.converted_label": "convertido",
  "settings.docs.failedLoad": "Error al cargar docs: {message}",
  "settings.docs.saveError": "Error al guardar: {message}",
  "settings.docs.status.pending": "Pendiente",
  "settings.docs.status.validated": "Validado",
  "settings.docs.status.rejected": "Rechazado",
  "settings.docs.status.auto_passed": "Aprobado automáticamente",
  ...
  "projects.empty.noneDesc":
    "Los proyectos aparecen cuando el asistente crea espacios de trabajo duraderos. Puedes empezar desde el chat y pedirle a BrassClaw que cree un proyecto con alcance para trabajo continuo.",
  ...
  "chat.heroPlaceholder": "Pregunta cualquier cosa a BrassClaw.",
