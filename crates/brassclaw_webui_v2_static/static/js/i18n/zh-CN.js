...
registerPack("zh-CN", {
  ...
  "chat.placeholder": "给 BrassClaw 发消息...",
  "chat.send": "发送消息",
  ...
  "settings.skills": "技能",
  "settings.actions": "动作",
  "settings.orchestrators": "编排器",
  "settings.scaffolds": "脚手架",
  "settings.montyVm": "Monty VM",
  "settings.validationQueue": "验证队列",
  "settings.docs": "智能体文档",
  "settings.docs.title": "智能体文档",
  "settings.docs.empty": "无文档",
  "settings.docs.save": "保存",
  "settings.docs.source_label": "来源",
  "settings.docs.converted_label": "已转换",
  "settings.docs.failedLoad": "加载文档失败：{message}",
  "settings.docs.saveError": "保存失败：{message}",
  "settings.docs.status.pending": "待处理",
  "settings.docs.status.validated": "已验证",
  "settings.docs.status.rejected": "已拒绝",
  "settings.docs.status.auto_passed": "自动通过",
  ...
  "projects.empty.noneDesc": "当助手创建持久化工作区后，项目就会出现。你可以从聊天开始，并让 BrassClaw 为持续工作创建一个范围项目。",
  ...
  "chat.heroPlaceholder": "向 BrassClaw 提问。",
