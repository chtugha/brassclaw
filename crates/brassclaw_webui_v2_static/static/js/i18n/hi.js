...
registerPack("hi", {
  ...
  "chat.placeholder": "BrassClaw को संदेश...",
  ...
  "settings.tools": "टूल्स",
  "settings.skills": "स्किल्स",
  ...
  "settings.docs": "एजेंट डॉक्स",
  "settings.docs.title": "एजेंट दस्तावेज़ीकरण",
  "settings.docs.empty": "कोई डॉक्स नहीं",
  "settings.docs.save": "सहेजें",
  "settings.docs.source_label": "स्रोत",
  "settings.docs.converted_label": "रूपांतरित",
  "settings.docs.failedLoad": "डॉक्स लोड करने में विफल: {message}",
  "settings.docs.saveError": "सहेजने में विफल: {message}",
  "settings.docs.status.pending": "लंबित",
  "settings.docs.status.validated": "सत्यापित",
  "settings.docs.status.rejected": "अस्वीकृत",
  "settings.docs.status.auto_passed": "स्वचालित रूप से पास",
  ...
  "projects.empty.noneDesc": "जब असिस्टेंट ड्यूरेबल वर्कस्पेस बनाता है तब प्रोजेक्ट दिखाई देते हैं। आप चैट से शुरू कर सकते हैं और BrassClaw से जारी काम के लिए स्कोप्ड प्रोजेक्ट बनाने को कह सकते हैं।",
  ...
  "chat.heroPlaceholder": "BrassClaw से कुछ भी पूछें.",
