...
registerPack("uk", {
  ...
  "login.console": "Консоль BrassClaw",
  ...
  "chat.placeholder": "Напишіть BrassClaw…",
  ...
  "settings.toolPermissions": "Дозволи інструментів",
  "settings.skillPackages": "Пакети скілів",
  ...
  "settings.docs": "Документація агента",
  "settings.docs.title": "Документація агента",
  "settings.docs.empty": "Немає документів",
  "settings.docs.save": "Зберегти",
  "settings.docs.source_label": "джерело",
  "settings.docs.converted_label": "конвертовано",
  "settings.docs.failedLoad": "Помилка завантаження документів: {message}",
  "settings.docs.saveError": "Помилка збереження: {message}",
  "settings.docs.status.pending": "Очікує",
  "settings.docs.status.validated": "Перевірено",
  "settings.docs.status.rejected": "Відхилено",
  "settings.docs.status.auto_passed": "Автоматично пройдено",
  ...
  "projects.empty.noneDesc": "Проєкти з’являються, коли асистент створює довговічні робочі простори. Ви можете почати з чату й попросити BrassClaw створити проєкт для тривалої роботи.",
  ...
  "chat.heroPlaceholder": "Запитайте BrassClaw про що завгодно.",
