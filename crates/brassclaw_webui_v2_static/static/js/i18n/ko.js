...
registerPack("ko", {
  ...
  "chat.placeholder": "BrassClaw에 메시지 보내기...",
  "chat.send": "메시지 보내기",
  ...
  "settings.toolPermissions": "도구 권한",
  "settings.tools": "도구",
  "settings.skills": "스킬",
  "settings.actions": "액션",
  "settings.orchestrators": "오케스트레이터",
  "settings.scaffolds": "스캐폴드",
  "settings.montyVm": "Monty VM",
  "settings.validationQueue": "검증 대기열",
  "settings.docs": "에이전트 문서",
  "settings.docs.title": "에이전트 문서",
  "settings.docs.empty": "문서 없음",
  "settings.docs.save": "저장",
  "settings.docs.source_label": "소스",
  "settings.docs.converted_label": "변환됨",
  "settings.docs.failedLoad": "문서 로드 실패: {message}",
  "settings.docs.saveError": "저장 실패: {message}",
  "settings.docs.status.pending": "대기 중",
  "settings.docs.status.validated": "검증됨",
  "settings.docs.status.rejected": "거부됨",
  "settings.docs.status.auto_passed": "자동 통과",
  ...
  "projects.empty.noneDesc": "어시스턴트가 지속 워크스페이스를 만들면 프로젝트가 나타납니다. 채팅에서 시작해 BrassClaw에게 지속 작업을 위한 프로젝트 생성을 요청할 수 있습니다.",
  ...
  "chat.heroPlaceholder": "BrassClaw에 무엇이든 물어보세요.",
