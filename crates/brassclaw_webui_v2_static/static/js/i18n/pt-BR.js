...
registerPack("pt-BR", {
  ...
  "login.console": "Console do BrassClaw",
  ...
  "chat.placeholder": "Mensagem para o BrassClaw...",
  ...
  "settings.toolPermissions": "Permissões de ferramentas",
  "settings.skillPackages": "Pacotes de skills",
  "settings.actions": "Ações",
  "settings.orchestrator": "Orquestrador",
  "settings.scaffold": "Scaffold",
  "settings.montyVm": "Monty VM",
  "settings.validationQueue": "Fila de validação",
  "settings.docs": "Documentação do Agente",
  "settings.docs.title": "Documentação do Agente",
  "settings.docs.empty": "Sem documentos",
  "settings.docs.save": "Salvar",
  "settings.docs.source_label": "fonte",
  "settings.docs.converted_label": "convertido",
  "settings.docs.failedLoad": "Falha ao carregar docs: {message}",
  "settings.docs.saveError": "Falha ao salvar: {message}",
  "settings.docs.status.pending": "Pendente",
  "settings.docs.status.validated": "Validado",
  "settings.docs.status.rejected": "Rejeitado",
  "settings.docs.status.auto_passed": "Aprovado automaticamente",

  "settings.reliability": "Confiabilidade",
  ...
  "projects.empty.noneDesc": "Projetos aparecem quando o assistente cria workspaces duráveis. Você pode começar no chat e pedir para o BrassClaw criar um projeto com escopo para trabalho contínuo.",
  ...
  "chat.heroPlaceholder": "Pergunte qualquer coisa ao BrassClaw.",
