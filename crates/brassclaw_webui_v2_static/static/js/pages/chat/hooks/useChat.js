...
const OAUTH_CALLBACK_CHANNEL = "brassclaw-product-auth";
const OAUTH_CALLBACK_STORAGE_KEY = "brassclaw:product-auth:oauth-complete";
const OAUTH_CALLBACK_MESSAGE_TYPE = "brassclaw:product-auth:oauth-complete";
