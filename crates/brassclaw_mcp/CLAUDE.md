...
- Keep MCP protocol concerns here; extension discovery belongs in `brassclaw_extensions`, network enforcement in `brassclaw_network`/host runtime egress, and product workflow outside this crate.
