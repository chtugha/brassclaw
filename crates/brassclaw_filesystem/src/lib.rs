//! Scoped filesystem service for BrassClaw Reborn.
//!
//! `brassclaw_filesystem` is the first service crate above
//! `brassclaw_host_api`. It resolves runtime-visible [`ScopedPath`] values
