...
const CALENDAR_READONLY_SCOPES: &[&str] = &[brassclaw_auth::GOOGLE_CALENDAR_READONLY_SCOPE];
const CALENDAR_EVENTS_SCOPES: &[&str] = &[brassclaw_auth::GOOGLE_CALENDAR_EVENTS_SCOPE];
const GMAIL_READONLY_SCOPES: &[&str] = &[brassclaw_auth::GOOGLE_GMAIL_READONLY_SCOPE];
const GMAIL_SEND_SCOPES: &[&str] = &[brassclaw_auth::GOOGLE_GMAIL_SEND_SCOPE];
const GMAIL_MODIFY_SCOPES: &[&str] = &[brassclaw_auth::GOOGLE_GMAIL_MODIFY_SCOPE];
pub const GSUITE_PROVIDER_SCOPES: &[&str] = &[
    brassclaw_auth::GOOGLE_CALENDAR_READONLY_SCOPE,
    brassclaw_auth::GOOGLE_CALENDAR_EVENTS_SCOPE,
    brassclaw_auth::GOOGLE_GMAIL_READONLY_SCOPE,
    brassclaw_auth::GOOGLE_GMAIL_SEND_SCOPE,
    brassclaw_auth::GOOGLE_GMAIL_MODIFY_SCOPE,
];
