...
/// Convert BrassClaw `ChatMessage` list into Bedrock system blocks + messages.
///
...
/// Build Bedrock `ToolConfiguration` from BrassClaw tool definitions.
...
/// Map Bedrock `StopReason` to BrassClaw `FinishReason`.
