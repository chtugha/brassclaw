...
use brassclaw_common::provider_transcript::strip_provider_transcript_artifact_lines;
...
pub struct Reasoning {
    ...
    platform_info: Option<brassclaw_common::PlatformInfo>,
}
...
impl Reasoning {
    ...
    pub fn with_platform_info(mut self, info: brassclaw_common::PlatformInfo) -> Self {
...
Respond directly with your final answer. Do not wrap your response in any special tags."#
        ...
        format!(
            r#"You are BrassClaw Agent, a secure autonomous assistant.
