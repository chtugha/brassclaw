...
- Do **not** depend on `brassclaw_llm`, `brassclaw_secrets`, `brassclaw_authorization`, or any upper substrate. Only `brassclaw_common` for env helpers.
