//! Shared OAuth callback infrastructure used by every BrassClaw OAuth flow
...
///
/// Checks `BRASSCLAW_OAUTH_CALLBACK_URL` env var first (useful for remote/VPS
...
pub fn callback_url() -> String {
    brassclaw_common::env_helpers::env_or_override("BRASSCLAW_OAUTH_CALLBACK_URL")
...
pub fn callback_host() -> String {
    brassclaw_common::env_helpers::env_or_override("OAUTH_CALLBACK_HOST")
...
mod tests {
    use super::*;
    use brassclaw_common::env_helpers::lock_env;
