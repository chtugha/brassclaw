...
use brassclaw_loop_support::{SkillBundleId, SkillBundleSource};
...
mod tests {
    ...
    async fn run_context() -> brassclaw_turns::run_profile::LoopRunContext {
        let resolved = InMemoryRunProfileResolver::default()
            .resolve_run_profile(RunProfileResolutionRequest::interactive_default())
            .await
            .unwrap();
        brassclaw_turns::run_profile::LoopRunContext::new(
            TurnScope::new(
