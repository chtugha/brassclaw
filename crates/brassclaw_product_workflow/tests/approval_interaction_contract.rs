...
use brassclaw_run_state::{ApprovalRequestStore, ApprovalStatus, InMemoryApprovalRequestStore};
use brassclaw_turns::{
...
impl ApprovalInteractionReadModel for FakeReadModel {
    ...
    ) -> Result<Vec<ApprovalGateRecord>, brassclaw_product_workflow::ProductWorkflowError> {
        Ok(self
            .gates
            .lock()
            .expect("lock")
    ...
    async fn approval_gate(
        ...
        gate_ref: &GateRef,
    ) -> Result<Option<ApprovalGateRecord>, brassclaw_product_workflow::ProductWorkflowError> {
        Ok(self
            .gates
            .lock()
            .expect("lock")
...
impl ApprovalLeaseTermsProvider for FixedLeaseTermsProvider {
    ...
    ) -> Result<LeaseApproval, brassclaw_product_workflow::ProductWorkflowError> {
...
impl ApprovalResolutionPort for RecordingApprovalResolver {
    ...
    ) -> Result<(), brassclaw_product_workflow::ProductWorkflowError> {
