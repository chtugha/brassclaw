...
use brassclaw_reborn_composition::ProductLiveCapabilityIo;
...
fn binding_with_user(user: &str, thread: &str) -> brassclaw_product_workflow::ResolvedBinding {
    let user_id = UserId::new(user).expect("valid user");
    brassclaw_product_workflow::ResolvedBinding {
...
fn turn_scope_for_binding(binding: &brassclaw_product_workflow::ResolvedBinding) -> TurnScope {
...
async fn user_message_no_profile_uses_product_live_runtime_and_persists_reply() {
    ...
    let composition = build_product_live_planned_runtime(DefaultPlannedRuntimeParts {
        ...
        subagent_goal_store: Arc::new(
            brassclaw_reborn::subagent::goal_store::InMemoryBoundedSubagentGoalStore::new(),
        ),
        subagent_gate_store: Arc::new(
            brassclaw_reborn::subagent::gate_resolution::BoundedSubagentGateResolutionStore::new(),
        ),
        subagent_definition_resolver: Arc::new(
            brassclaw_reborn::subagent::flavors::StaticSubagentDefinitionResolver,
        ),
