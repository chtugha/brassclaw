...
//!
//! This module consumes the `brassclaw_auth` continuation vocabulary and routes
...
use brassclaw_auth::{AuthContinuationEvent, AuthContinuationRef, AuthProductError};
use brassclaw_turns::{
...
fn auth_continuation_binding_id(
    flow_id: brassclaw_auth::AuthFlowId,
    run_id: &TurnRunId,
    gate_ref: &str,
) -> String {
    format!(
