...
use brassclaw_product_adapters::ProductWorkflowRejectionKind;
use brassclaw_turns::{CancelRunResponse, GateRef, IdempotencyKey, ResumeTurnResponse, TurnActor};
...
pub struct AuthInteractionScope {
    pub tenant_id: brassclaw_host_api::TenantId,
    pub user_id: brassclaw_host_api::UserId,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub agent_id: Option<brassclaw_host_api::AgentId>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub enum AuthInteractionChallengeView {
    ...
    ManualTokenRequired {
        interaction_id: brassclaw_auth::AuthInteractionId,
...
pub struct PendingAuthInteractionView {
    ...
    pub provider: brassclaw_auth::AuthProviderId,
    pub summary: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
