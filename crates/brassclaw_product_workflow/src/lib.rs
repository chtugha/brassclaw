//! Product-facing workflow facade for BrassClaw Reborn.
//!
//! `brassclaw_product_workflow` sits between product adapters and host-layer
...
//!   [`brassclaw_product_adapters::ProductWorkflow`].
...
//!   `brassclaw_conversations` using trusted installation configuration for
...
pub use reborn_services::{
    ...
    AutomationStateAction, CodexLoginStart, ConnectableChannelsProductFacade, DocusItem,
    DocusListResponse, DocusStore, ExtensionCredentialSetupService,
    ...
    SetActiveLlmRequest, StaticConnectableChannelsProductFacade,
    UnsupportedAutomationProductFacade, UnsupportedOutboundPreferencesProductFacade,
    UpdateDocusRequest, UpsertLlmProviderRequest, WebUiCreateAutomationRequest,
