...
use brassclaw_prompt_envelope::{EnvelopeError, EnvelopeSource, EnvelopeTrust, wrap_untrusted};
...
pub(crate) enum SnippetBody {
    ...
    /// `brassclaw_host_runtime::memory_context`; extraction tracked separately)
