# Agent Map - brassclaw_event_streams
...
- Use these Reborn contracts before changing behavior:
  ...
  - `crates/brassclaw_event_projections/AGENTS.md`
...
- Fast local check: `cargo test -p brassclaw_event_streams --locked`
- Boundary check after dependency/API changes: `cargo test -p brassclaw_architecture reborn --locked`
- Run `cargo clippy -p brassclaw_event_streams --all-targets -- -D warnings` before requesting review.
