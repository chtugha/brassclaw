# Agent Map — brassclaw_wasm_product_adapters
...
- Use these neighboring contracts before changing behavior:
  ...
  - `crates/brassclaw_wasm_sandbox_core/CLAUDE.md`
...
- Shared product-surface DTOs; keep those in `brassclaw_product_adapters`.
...
- Fast local check: `cargo test -p brassclaw_wasm_product_adapters`
- Focused check: `cargo test -p brassclaw_wasm_product_adapters --test component_runtime_contract`
