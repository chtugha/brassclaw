# brassclaw_wasm_sandbox_core guardrails

Owns shared v1-style WASM sandbox primitives for BrassClaw runtimes.
...
- `brassclaw_architecture` pins workspace independence and ProductAdapter usage.
