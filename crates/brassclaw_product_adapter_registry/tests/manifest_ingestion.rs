use brassclaw_extensions::{ExtensionManifestRecord, MANIFEST_SCHEMA_VERSION, ManifestSource};
use brassclaw_host_api::HostPortCatalog;
use brassclaw_product_adapter_registry::{
    ManifestHash, RegistryError, parse_product_adapter_manifest_record, product_adapter_sections,
};
use brassclaw_product_adapters::{AuthRequirement, ProductCapabilityFlag, ProductSurfaceKind};
