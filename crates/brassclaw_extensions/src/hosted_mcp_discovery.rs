...
struct HostedMcpCapabilityTemplate {
    ...
    required_host_ports: Vec<brassclaw_host_api::HostPortId>,
    runtime_credentials: Vec<brassclaw_host_api::RuntimeCredentialRequirement>,
    resource_profile: Option<brassclaw_host_api::ResourceProfile>,
}
...
mod tests {
    ...
    use brassclaw_host_api::{EffectKind, RuntimeKind, VirtualPath};
