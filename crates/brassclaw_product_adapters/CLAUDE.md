# brassclaw_product_adapters guardrails

Owns the product-surface adapter boundary for BrassClaw Reborn (issue #3269).
...
- Stay above the kernel/dispatcher layer. Do **not** depend on or re-export
  ...
  `brassclaw_turns::runner` trusted transition APIs. Boundary tests in
