# Agent Map — brassclaw_product_adapters
...
- Fast local check: `cargo test -p brassclaw_product_adapters`
- Contract checks: `cargo test -p brassclaw_product_adapters --test product_adapter_contract`
- Review-regression checks: `cargo test -p brassclaw_product_adapters --test review_findings_contract`
