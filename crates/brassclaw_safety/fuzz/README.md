# brassclaw_safety Fuzz Targets

Fuzz testing for the `brassclaw_safety` crate using [cargo-fuzz](https://github.com/rust-fuzz/cargo-fuzz) (libFuzzer).
