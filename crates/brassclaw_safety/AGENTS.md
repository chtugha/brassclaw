...
- `crates/brassclaw_safety/fuzz/README.md`
...
- Fast local check: `cargo test -p brassclaw_safety`
- Fuzz-target check after parser/pattern changes: follow `crates/brassclaw_safety/fuzz/README.md`
