...
- Production backend selection lives in `brassclaw_reborn_event_store`, not here — downstream store crates depend on this substrate, never the reverse.
...
- Fast local check: `cargo test -p brassclaw_events`
