...
/// `brassclaw_hooks::HookId::to_hex`; values of any other shape are rejected so
...
mod tests {
    use super::*;
    use brassclaw_host_api::{AgentId, InvocationId, ProjectId, TenantId, UserId};
