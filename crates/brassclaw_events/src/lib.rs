...
//! BrassClaw Reborn.
//!
//! `brassclaw_events` defines the small redacted vocabulary every
...
//!   in `brassclaw_reborn_event_store`, which depends on these traits rather
//!   than pulling storage drivers back into `brassclaw_events`.
//!
