...
//!
//! - [`brassclaw_hooks::predicate_state::InMemoryPredicateStateBackend`] (the
//!   in-process backend; PR 1/4),
//! - [`brassclaw_hooks_postgres::PostgresPredicateStateBackend`] (PR 2/4),
//! - [`brassclaw_hooks_libsql::LibSqlPredicateStateBackend`] (PR 3/4),
//!
...
//!
//! [`WindowOverflow`]: brassclaw_hooks::predicate_state::PredicateBackendError::WindowOverflow
//!
//! See `tests/parity_matrix.rs` for the load-bearing matrix and the
//! durable-backend doc `crates/brassclaw_hooks/docs/successors/03-persistent-counter.md`
