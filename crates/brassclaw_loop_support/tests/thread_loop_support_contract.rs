...
use brassclaw_host_api::{AgentId, CapabilityId, ProjectId, TenantId, ThreadId, UserId};
use brassclaw_loop_support::{
    ...
    IdentityApplicability, IdentityBudget, IdentityFileName, ThreadBackedLoopContextPort,
    ThreadBackedLoopModelPort, ThreadBackedLoopTranscriptPort, identity_message_ref,
};
...
use brassclaw_turns::{
    ...
    run_profile::{
        ...
        InMemoryRunProfileResolver, LoopCapabilityPort, LoopContextBundle, LoopContextSnippet,
        LoopContextCompactionKind, LoopContextMessage, LoopContextPort, LoopContextRequest,
        LoopDriverNoteKind, LoopHostMilestoneKind, LoopHostMilestoneSink,
        ...
        PersonalContextPolicy, PromptMode, ProviderToolCallReference,
        ProviderToolDefinition, ToolObservationDetail, ToolObservationStatus,
...
async fn thread_context_port_preserves_summary_replacements_as_system_messages() {
    ...
    fixture
        ...
        .create_summary_artifact(CreateSummaryArtifactRequest {
            ...
            start_sequence: 1,
            end_sequence: 1,
            summary_kind: brassclaw_threads::SummaryKind::Compaction,
...
async fn model_port_preserves_capability_info_for_filtered_capability_view() {
    ...
    .with_capability_port(Arc::new(StaticToolDefinitionPort::new(vec![
        provider_tool_definition(
            CapabilityId::new("brassclaw.loop.capability_info").unwrap(),
            "capability_info",
        ),
        provider_tool_definition(allowed_id.clone(), "demo__allowed"),
        provider_tool_definition(hidden_id, "demo__hidden"),
...
async fn transcript_port_appends_tool_result_reference_envelope_idempotently() {
    ...
    let context = fixture
        .thread_service
        .load_context_window(brassclaw_threads::LoadContextWindowRequest {
            scope: fixture.thread_scope.clone(),
            thread_id: fixture.thread_id.clone(),
            max_messages: 16,
        })
...
impl LoopContextPort for StaticLoopContextPort {
    ...
    ) -> Result<LoopContextBundle, brassclaw_turns::run_profile::AgentLoopHostError> {
...
struct ThreadFixture {
    ...
    thread_id: ThreadId,
    user_message_id: brassclaw_threads::ThreadMessageId,
...
impl SessionThreadService for GatedFinalizeThreadService {
    ...
    async fn load_context_window(
        &self,
        request: brassclaw_threads::LoadContextWindowRequest,
...
struct FailOnceMilestoneSink {
    attempts: Mutex<Vec<brassclaw_turns::run_profile::LoopHostMilestone>>,
}
...
async fn wait_for_in_memory_milestones(
    ...
    expected: usize,
) -> Vec<brassclaw_turns::run_profile::LoopHostMilestone> {
    for _ in 0..20 {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopHostMilestoneSink for FailOnceMilestoneSink {
    async fn publish_loop_milestone(
        ...
        if attempts.is_empty() {
            ...
            return Err(brassclaw_turns::run_profile::AgentLoopHostError::new(
...
struct FailOnModelStartedMilestoneSink {
    published: Mutex<Vec<brassclaw_turns::run_profile::LoopHostMilestone>>,
}
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopHostMilestoneSink for FailOnModelStartedMilestoneSink {
    async fn publish_loop_milestone(
        &self,
        milestone: brassclaw_turns::run_profile::LoopHostMilestone,
    ) -> Result<(), brassclaw_turns::run_profile::AgentLoopHostError> {
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopHostMilestoneSink for FailOnModelCompletedMilestoneSink {
    async fn publish_loop_milestone(
        &self,
        milestone: brassclaw_turns::run_profile::LoopHostMilestone,
    ) -> Result<(), brassclaw_turns::run_profile::AgentLoopHostError> {
