...
use brassclaw_safety::{InjectionScanner, LeakDetector, LeakScanner, Sanitizer};
...
fn compaction_message_body(
    message: &brassclaw_threads::ThreadMessageRecord,
...
mod tests {
    use super::*;
    use brassclaw_threads::{ThreadMessageId, ThreadMessageRecord};
