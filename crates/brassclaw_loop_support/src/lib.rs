//! Loop support services for BrassClaw Reborn.
//!
...
#[async_trait]
impl brassclaw_turns::run_profile::LoopCapabilityPort for EmptyLoopCapabilityPort {
...
/// snapshot DTO here.
pub type HostManagedModelRouteSnapshot = brassclaw_turns::run_profile::LoopModelRouteSnapshot;
...
impl HostManagedModelResponse {
    ...
    pub fn capability_calls(
        calls: Vec<brassclaw_turns::run_profile::CapabilityCallCandidate>,
...
fn provider_call_reference_to_envelope(
    provider_call: brassclaw_turns::run_profile::ProviderToolCallReference,
