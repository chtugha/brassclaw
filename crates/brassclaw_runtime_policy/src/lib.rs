//! Runtime profile resolver for BrassClaw Reborn.
//!
...
//!
//! It depends only on the contract vocabulary in [`brassclaw_host_api`] —
...
// re-exported here — callers consume them directly from `brassclaw_host_api`.
pub use brassclaw_host_api::runtime_policy::EffectiveRuntimePolicy;
