...
//! (`brassclaw_hooks::predicate_state::InMemoryPredicateStateBackend`) against a
...
//!
//! [`PredicateStateBackend`]: brassclaw_hooks::predicate_state::PredicateStateBackend
//!
...
//!
//! [`MAX_SAMPLES_PER_KEY`]: brassclaw_hooks::predicate_state::MAX_SAMPLES_PER_KEY
//! [`PredicateBackendError::WindowOverflow`]: brassclaw_hooks::predicate_state::PredicateBackendError::WindowOverflow
//!
...
/// `brassclaw_hooks/docs/successors/03-persistent-counter.md` (Reaper
...
///
/// [`MAX_HISTORY_KEYS`]: brassclaw_hooks::predicate_state::MAX_HISTORY_KEYS
/// [`MAX_KEYS_PER_TENANT`]: brassclaw_hooks::predicate_state::MAX_KEYS_PER_TENANT
/// [`PredicateStateBackend::evict_older_than`]: brassclaw_hooks::predicate_state::PredicateStateBackend::evict_older_than
