//! Shared host API contracts for BrassClaw Reborn.
//!
//! `brassclaw_host_api` is the vocabulary every Reborn system-service crate uses
...
// `brassclaw_host_api` as a contract prelude, while module docs remain the
