...
fn scoped_path_rejects_raw_host_paths_urls_and_traversal() {
    ...
    for invalid in [
        ...
        "/Users/alice/project",
        "/opt/brassclaw/project",
        "/tmp/brassclaw/project",
...
fn scoped_path_redacts_all_rejected_values_in_error_display() {
    for invalid in [
        ...
        "/opt/brassclaw/project/private.txt",
        "/tmp/brassclaw/project/private.txt",
...
fn requested_trust_class_round_trips_all_variants() {
    ...
    // become real after policy evaluation in brassclaw_trust.
    for (raw, expected) in [
