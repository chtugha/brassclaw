...
use brassclaw_reborn::model_gateway::{
...
async fn provider_pool_rejects_wrong_provider_identity_with_same_model() {
    ...
    let key = brassclaw_reborn::model_routes::ModelRouteProviderKey::for_route(route);
...
impl HostManagedModelGateway for InvalidSummaryModelGateway {
    async fn stream_model(
        ...
        brassclaw_loop_support::HostManagedModelError,
    > {
        Err(brassclaw_loop_support::HostManagedModelError::safe(
            self.kind,
...
impl LoopCapabilityPort for GatewayCapabilityPort {
    fn tool_definitions(
        &self,
    ) -> Result<Vec<ProviderToolDefinition>, brassclaw_turns::run_profile::AgentLoopHostError> {
    ...
    fn validate_provider_tool_call(
        ...
        let arguments_len = serde_json::to_vec(&tool_call.arguments)
            .map_err(|error| {
                brassclaw_turns::run_profile::AgentLoopHostError::new(
                    AgentLoopHostErrorKind::InvalidInvocation,
                    error.to_string(),
                )
            })?
    ...
    ) -> Result<VisibleCapabilitySurface, brassclaw_turns::run_profile::AgentLoopHostError> {
    ...
    async fn invoke_capability(
        ...
        brassclaw_turns::run_profile::CapabilityOutcome,
        brassclaw_turns::run_profile::AgentLoopHostError,
    > {
    ...
    async fn invoke_capability_batch(
        ...
        brassclaw_turns::run_profile::CapabilityBatchOutcome,
        brassclaw_turns::run_profile::AgentLoopHostError,
    > {
