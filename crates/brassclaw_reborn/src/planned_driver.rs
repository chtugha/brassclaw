...
//! the sealed `brassclaw_agent_loop` framework. It intentionally holds an opaque
...
mod tests {
    ...
    use brassclaw_agent_loop::test_support::{
    ...
    fn default_planned_driver_descriptor_uses_default_family_identity() {
        ...
        assert_eq!(
            ...
            // `use super::*` -> `use brassclaw_agent_loop::state::*`) — the
    ...
    ) -> brassclaw_turns::run_profile::LoopRunContext {
        let descriptor = driver.descriptor();
