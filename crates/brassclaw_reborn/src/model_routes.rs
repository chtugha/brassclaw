...
/// Minimal bridge from existing active BrassClaw model settings into Reborn's
...
impl ActiveModelRouteSettings {
    ...
    pub fn from_llm_config(config: &brassclaw_llm::LlmConfig) -> Result<Self, ModelRouteError> {
