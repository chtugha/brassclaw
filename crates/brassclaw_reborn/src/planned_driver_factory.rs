...
pub fn planned_driver_default_id() -> Result<brassclaw_turns::run_profile::LoopDriverId, String> {
    brassclaw_turns::run_profile::LoopDriverId::new(PLANNED_DRIVER_DEFAULT_ID)
}
...
pub(crate) fn is_subagent_planned_profile(
    profile: &brassclaw_turns::run_profile::ResolvedRunProfile,
) -> bool {
...
pub(crate) fn is_subagent_planned_run_profile(
    run_context: &brassclaw_turns::run_profile::LoopRunContext,
) -> bool {
