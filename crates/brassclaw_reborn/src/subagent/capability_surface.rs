...
mod tests {
    ...
    use brassclaw_loop_support::CapabilitySurfaceProfileResolver;
    use brassclaw_loop_support::{
    ...
    fn planned_subagent_context() -> LoopRunContext {
        ...
        context.resolved_run_profile.loop_driver.id =
            brassclaw_turns::run_profile::LoopDriverId::new(SUBAGENT_PLANNED_DRIVER_ID)
    ...
    #[async_trait]
    impl brassclaw_loop_support::CapabilitySurfaceProfileResolver for StaticResolver {
        async fn resolve(
            &self,
    ...
    #[async_trait]
    impl brassclaw_loop_support::CapabilitySurfaceProfileResolver for FailingResolver {
        async fn resolve(
            &self,
            _run_context: &LoopRunContext,
        ) -> Result<CapabilityAllowSet, CapabilityResolveError> {
    ...
    async fn resolve_intersects_base_and_material_allowsets_for_subagent_context() {
        ...
        let resolver = SubagentCapabilitySurfaceResolver::new(
            ...
            Arc::new(SucceedingSource(SubagentPromptMaterial {
                ...
                goal: brassclaw_loop_support::SubagentPromptGoal {
                    task: "test".to_string(),
                    handoff: None,
                },
