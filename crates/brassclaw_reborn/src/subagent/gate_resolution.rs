...
use brassclaw_loop_support::{AwaitedChildSetRecord, SubagentGateResolutionStore, SubagentKindId};
use brassclaw_turns::{
...
mod tests {
    ...
    use brassclaw_loop_support::SpawnSubagentMode;
    use brassclaw_turns::{LoopResultRef, ReplyTargetBindingRef, SourceBindingRef, TurnScope};
    ...
    fn record(gate_ref: &str, child_run_id: TurnRunId) -> AwaitedChildSetRecord {
        ...
        let mut parent_run_context =
            brassclaw_agent_loop::test_support::test_run_context("subagent-gate");
    ...
    fn terminal_event(status: TurnStatus) -> AwaitedChildTerminalEvent {
        AwaitedChildTerminalEvent {
            ...
            owner_user_id: Some(brassclaw_host_api::UserId::new("owner").unwrap()),
        }
    }
