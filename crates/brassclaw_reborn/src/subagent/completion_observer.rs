...
use brassclaw_host_api::{CapabilityId, UserId};
    ...
    S: SessionThreadService + ?Sized,
{
    ...
    async fn reconstruct_record(
        ...
        let parent_scope = brassclaw_turns::TurnScope::new(
            child_record.scope.tenant_id.clone(),
    ...
    async fn release_descendant_reservation(
        &self,
        record: &brassclaw_loop_support::AwaitedChildSetRecord,
    ) -> Result<(), TurnError> {
        if !self
            .gate_store
    ...
    async fn mark_child_deliveries(
        &self,
        records: Vec<brassclaw_loop_support::AwaitedChildSetRecord>,
    ) -> Result<(), TurnError> {
        let mut marked: Vec<brassclaw_loop_support::AwaitedChildSetRecord> = Vec::new();
    ...
    async fn update_parent_result_reference(
        ...
        record: &brassclaw_loop_support::AwaitedChildSetRecord,
        event: &AwaitedChildTerminalEvent,
        result_ref: &brassclaw_turns::LoopResultRef,
...
fn parse_optional_subagent_thread_metadata(
    raw: Option<&str>,
    child_run_id: brassclaw_turns::TurnRunId,
...
mod tests {
    ...
    impl LoopCapabilityResultWriter for RecordingResultWriter {
        ...
        async fn update_capability_result(
            &self,
            _run_context: &brassclaw_turns::run_profile::LoopRunContext,
            result_ref: &LoopResultRef,
    ...
    impl SessionThreadService for NoResolveThreadService {
        ...
        ) -> Result<brassclaw_threads::SessionThreadRecord, brassclaw_threads::SessionThreadError>
        {
        ...
        async fn accept_inbound_message(
            &self,
            _request: brassclaw_threads::AcceptInboundMessageRequest,
        ) -> Result<brassclaw_threads::AcceptedInboundMessage, brassclaw_threads::SessionThreadError>
        {
            Err(brassclaw_threads::SessionThreadError::Backend(
                "not used".to_string(),
            ))
        ...
        async fn replay_accepted_inbound_message(
            &self,
            _request: brassclaw_threads::ReplayAcceptedInboundMessageRequest,
        ) -> Result<
            Option<brassclaw_threads::AcceptedInboundMessageReplay>,
            brassclaw_threads::SessionThreadError,
        > {
            Err(brassclaw_threads::SessionThreadError::Backend(
                "not used".to_string(),
            ))
        ...
        async fn mark_message_submitted(
            ...
            _scope: &ThreadScope,
            _thread_id: &ThreadId,
            _message_id: brassclaw_threads::ThreadMessageId,
            _turn_id: String,
            _turn_run_id: String,
        ) -> Result<brassclaw_threads::ThreadMessageRecord, brassclaw_threads::SessionThreadError>
        {
            Err(brassclaw_threads::SessionThreadError::Backend(
                "not used".to_string(),
            ))
        ...
        async fn append_capability_display_preview(
            &self,
            _request: brassclaw_threads::AppendCapabilityDisplayPreviewRequest,
        ) -> Result<brassclaw_threads::ThreadMessageRecord, brassclaw_threads::SessionThreadError>
        {
            Err(brassclaw_threads::SessionThreadError::Backend(
                "not used".to_string(),
        ...
        async fn update_assistant_draft(
            &self,
            _request: brassclaw_threads::UpdateAssistantDraftRequest,
        ) -> Result<brassclaw_threads::ThreadMessageRecord, brassclaw_threads::SessionThreadError>
        {
            Err(brassclaw_threads::SessionThreadError::Backend(
                "not used".to_string(),
        ...
        async fn redact_message(
            &self,
            _request: brassclaw_threads::RedactMessageRequest,
        ) -> Result<brassclaw_threads::ThreadMessageRecord, brassclaw_threads::SessionThreadError>
        {
            Err(brassclaw_threads::SessionThreadError::Backend(
                "not used".to_string(),
        ...
        async fn load_context_messages(
            &self,
            _request: brassclaw_threads::LoadContextMessagesRequest,
        ) -> Result<brassclaw_threads::ContextMessages, brassclaw_threads::SessionThreadError>
        {
            Err(brassclaw_threads::SessionThreadError::Backend(
                "not used".to_string(),
            ))
        ...
        async fn create_summary_artifact(
            &self,
            _request: brassclaw_threads::CreateSummaryArtifactRequest,
        ) -> Result<brassclaw_threads::SummaryArtifact, brassclaw_threads::SessionThreadError>
        {
            Err(brassclaw_threads::SessionThreadError::Backend(
                "not used".to_string(),
            ))
    ...
    impl TurnSpawnTreeStateStore for RecordingTurnStateStore {
        async fn submit_child_turn(
            &self,
            _request: brassclaw_turns::SubmitChildRunRequest,
            _admission_policy: &dyn brassclaw_turns::TurnAdmissionPolicy,
            _run_profile_resolver: &dyn brassclaw_turns::RunProfileResolver,
        ) -> Result<SubmitTurnResponse, TurnError> {
            Err(TurnError::Unavailable {
    ...
    fn test_state(status: TurnStatus) -> TurnRunState {
        TurnRunState {
            ...
            turn_id: brassclaw_turns::TurnId::new(),
    ...
    async fn handle_claimed_states_returns_unavailable_when_terminal_event_missing() {
        ...
        let mut parent_run_context =
            brassclaw_agent_loop::test_support::test_run_context("missing-terminal-parent");
    ...
    async fn recover_owner_user_id_uses_gate_record_actor_without_run_record() {
        ...
        let child_run_id = TurnRunId::new();
        let mut parent_run_context =
            brassclaw_agent_loop::test_support::test_run_context("owner-from-gate");
    ...
    async fn handle_terminal_state_ignores_non_terminal_statuses() {
        let context =
            brassclaw_agent_loop::test_support::test_run_context("completion-observer-nonterminal");
        let turn_state_store = Arc::new(RecordingTurnStateStore::default());
    ...
    async fn background_terminal_event_releases_reservation_writes_result_and_delivers_message() {
        ...
        goal_store
            ...
            .unwrap();
        let mut parent_run_context =
            brassclaw_agent_loop::test_support::test_run_context("completion-observer");
        ...
        let mut child_run_context =
            brassclaw_agent_loop::test_support::test_run_context("completion-observer-child");
    ...
    async fn terminal_event_after_restart_updates_parent_reference_without_staged_payload() {
        ...
        let goal_store = Arc::new(InMemoryBoundedSubagentGoalStore::new());
        let mut parent_run_context =
            brassclaw_agent_loop::test_support::test_run_context("completion-observer-recovery");
        parent_run_context.scope = parent_scope.clone();
        parent_run_context.thread_id = parent_scope.thread_id.clone();
        parent_run_context.run_id = parent_run_id;
        gate_store
    ...
    async fn terminal_event_after_restart_reconstructs_missing_gate_from_thread_metadata() {
        ...
        let mut parent_run_context =
            brassclaw_agent_loop::test_support::test_run_context("completion-observer-parent");
        parent_run_context.scope = parent_scope.clone();
        parent_run_context.thread_id = parent_scope.thread_id.clone();
        parent_run_context.run_id = parent_run_id;
    ...
    async fn terminal_event_after_restart_skips_malformed_recovery_metadata() {
        ...
        let mut parent_run_context =
            brassclaw_agent_loop::test_support::test_run_context("malformed-metadata-parent");
        parent_run_context.scope = parent_scope.clone();
        parent_run_context.thread_id = parent_scope.thread_id.clone();
        parent_run_context.run_id = parent_run_id;

        let mut child_run_context =
            brassclaw_agent_loop::test_support::test_run_context("malformed-metadata-child");
        child_run_context.scope = child_scope.clone();
        child_run_context.thread_id = child_scope.thread_id.clone();
        child_run_context.run_id = child_run_id;
    ...
    async fn persisted_blocking_reconstruction_preserves_existing_parent_gate_ref() {
        ...
        let mut parent_context =
            brassclaw_agent_loop::test_support::test_run_context("legacy-parent");
    ...
    async fn recovery_required_child_resolves_parent_reference() {
        ...
        let gate_store = Arc::new(BoundedSubagentGateResolutionStore::new());
        let goal_store = Arc::new(InMemoryBoundedSubagentGoalStore::new());
        let mut parent_run_context = brassclaw_agent_loop::test_support::test_run_context(
    ...
    fn background_completion_payload_sanitizes_terminal_event_reason_without_fallback() {
        ...
        let child_run_id = TurnRunId::new();
        let mut parent_run_context =
            brassclaw_agent_loop::test_support::test_run_context("payload-parent");
        parent_run_context.scope = parent_scope.clone();
        parent_run_context.thread_id = parent_scope.thread_id.clone();
    ...
    async fn blocking_terminal_event_invokes_resume_parent_with_dependent_run_precondition() {
        ...
        let mut parent_run_context =
            brassclaw_agent_loop::test_support::test_run_context("completion-observer-blocking");
        parent_run_context.scope = parent_scope.clone();
        parent_run_context.thread_id = parent_scope.thread_id.clone();
        parent_run_context.run_id = parent_run_id;
        gate_store
    ...
    async fn shared_batch_terminal_event_claims_all_states_once() {
        ...
        let goal_store = Arc::new(InMemoryBoundedSubagentGoalStore::new());
        let mut parent_run_context =
            brassclaw_agent_loop::test_support::test_run_context("completion-observer-shared");
        parent_run_context.scope = parent_scope.clone();
        parent_run_context.thread_id = parent_scope.thread_id.clone();
        parent_run_context.run_id = parent_run_id;
    ...
    async fn blocking_batch_resume_failure_does_not_mark_earlier_child_delivered() {
        ...
        let goal_store = Arc::new(InMemoryBoundedSubagentGoalStore::new());
        let mut parent_run_context =
            brassclaw_agent_loop::test_support::test_run_context("blocking-resume-failure");
        parent_run_context.scope = parent_scope.clone();
        parent_run_context.thread_id = parent_scope.thread_id.clone();
        parent_run_context.run_id = parent_run_id;
        let records = [
    ...
    async fn handle_claimed_terminal_states_rolls_back_first_delivery_when_second_mark_fails() {
        ...
        let goal_store = Arc::new(InMemoryBoundedSubagentGoalStore::new());
        let mut parent_run_context =
            brassclaw_agent_loop::test_support::test_run_context("completion-observer-rollback");
        parent_run_context.scope = parent_scope.clone();
        parent_run_context.thread_id = parent_scope.thread_id.clone();
        parent_run_context.run_id = parent_run_id;
        let records = [
    ...
    async fn blocking_terminal_event_on_unbound_coordinator_returns_unavailable() {
        ...
        let goal_store = Arc::new(InMemoryBoundedSubagentGoalStore::new());
        let mut parent_run_context =
            brassclaw_agent_loop::test_support::test_run_context("completion-observer-unbound");
        parent_run_context.scope = parent_scope.clone();
        parent_run_context.thread_id = parent_scope.thread_id.clone();
        parent_run_context.run_id = parent_run_id;
        gate_store
