...
pub(super) fn claimed_run() -> ClaimedTurnRun {
    let descriptor = brassclaw_turns::AgentLoopDriverDescriptor {
...
fn test_profile(
    descriptor: brassclaw_turns::AgentLoopDriverDescriptor,
    ...
    async fn apply_validated_loop_exit(
        ...
        *self.apply_calls.lock().expect("lock") += 1;
        match request.mapping {
            brassclaw_turns::LoopExitMapping::RunnerOutcome(outcome) => match outcome {
                brassclaw_turns::runner::TurnRunnerOutcome::Completed => {
                ...
                brassclaw_turns::runner::TurnRunnerOutcome::Cancelled => {
                ...
                brassclaw_turns::runner::TurnRunnerOutcome::Blocked {
                    checkpoint_id: _,
                    state_ref: _,
                    reason,
                } => {
                ...
                brassclaw_turns::runner::TurnRunnerOutcome::Failed { failure } => {
            ...
            brassclaw_turns::LoopExitMapping::RecoveryRequired { failure } => {
