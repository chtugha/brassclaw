...
impl RebornLocalSkillManagementPort {
    ...
    pub(crate) async fn list(
        &self,
    ) -> Result<Vec<brassclaw_skills::SkillSummary>, RebornLocalSkillManagementError> {
    ...
    pub(crate) async fn search(
        ...
        query: &str,
        limit: usize,
    ) -> Result<brassclaw_skills::SkillSearchResult, RebornLocalSkillManagementError> {
        let context = self.skill_context()?;
...
fn skill_summary(
    skill: brassclaw_skills::SkillSummary,
    ...
    Ok(LifecycleSkillSummary {
        ...
        source: match skill.source {
            brassclaw_skills::ManagedSkillSource::System => LifecycleSkillSource::System,
            brassclaw_skills::ManagedSkillSource::User
            | brassclaw_skills::ManagedSkillSource::Installed => LifecycleSkillSource::User,
        },
