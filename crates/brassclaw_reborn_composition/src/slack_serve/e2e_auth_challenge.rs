...
use brassclaw_auth::{AuthProductError, AuthProviderId, OAuthAuthorizationUrl};
use brassclaw_host_api::{AgentId, ProjectId, UserId};
...
type AuthChallengeCall = (
    ...
    TurnRunId,
    String,
    Vec<brassclaw_host_api::RuntimeCredentialAuthRequirement>,
);
