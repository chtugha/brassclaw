...
mod tests {
    ...
    use brassclaw_trust::{HostTrustPolicy, InvalidationBus, TrustPolicy};
    ...
    async fn extension_lifecycle_installs_activates_and_removes_catalog_package() {
        ...
        assert!(
            active
                .get_capability(&brassclaw_host_api::CapabilityId::new("fixture.search").unwrap())
                .is_some()
        );
        assert!(
            active
                .get_capability(&brassclaw_host_api::CapabilityId::new("fixture.write").unwrap())
                .is_some()
        );
    ...
    async fn extension_activation_updates_local_dev_host_trust_policy() {
        ...
        assert_eq!(
            ...
            brassclaw_trust::TrustProvenance::AdminConfig
        );
        assert_eq!(
    ...
    async fn active_extension_trust_policy_is_digest_pinned() {
        ...
        assert_eq!(
            ...
            brassclaw_trust::TrustProvenance::Default
        );
    }
    ...
    async fn extension_lifecycle_installs_activates_and_removes_gsuite() {
        ...
        assert!(
            active
                .get_capability(
                    &brassclaw_host_api::CapabilityId::new("gmail.send_message").unwrap()
                )
                .is_some()
        );
    ...
    impl ExtensionInstallationStore for DeleteInstallationFailingStore {
        ...
        async fn update_health(
            &self,
            installation_id: &ExtensionInstallationId,
            health: brassclaw_extensions::ExtensionHealthSnapshot,
        ) -> Result<(), ExtensionInstallationError> {
    ...
    impl RootFilesystem for DeleteFailingRootFilesystem {
        fn capabilities(&self) -> brassclaw_filesystem::BackendCapabilities {
    ...
    fn test_extension_trust_policy() -> Arc<HostTrustPolicy> {
        Arc::new(
            HostTrustPolicy::new(vec![Box::new(brassclaw_trust::AdminConfig::new())])
...
"#
    ...
    fn fixture_manifest_record_with_source(
        ...
        let host_ports =
            brassclaw_host_runtime::default_host_port_catalog().expect("host port catalog");
