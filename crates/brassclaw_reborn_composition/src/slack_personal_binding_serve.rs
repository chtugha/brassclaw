...
mod tests {
    ...
    fn tenant(value: &str) -> brassclaw_host_api::TenantId {
        brassclaw_host_api::TenantId::new(value).expect("tenant")
    }

    fn user(value: &str) -> brassclaw_host_api::UserId {
        brassclaw_host_api::UserId::new(value).expect("user")
    }
