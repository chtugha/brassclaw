...
use brassclaw_loop_support::SkillFilePath;
use brassclaw_skills::{ManagedSkillSource, SkillSummary};
...
const BUNDLED_MARKER_FILE: &str = ".brassclaw-reborn-bundled.json";
const BUNDLED_INSTALL_LOCK_FILE: &str = ".brassclaw-reborn-bundled.lock";
const BUNDLED_MARKER_OWNER: &str = "brassclaw_reborn_composition_bundled_skill";
