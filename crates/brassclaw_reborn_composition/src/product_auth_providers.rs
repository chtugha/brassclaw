...
use brassclaw_host_api::RuntimeHttpEgress;
use brassclaw_host_runtime::ProductAuthProviderRuntimePorts;
...
mod tests {
    ...
    use brassclaw_capabilities::{CapabilityObligationError, CapabilityObligationRequest};
