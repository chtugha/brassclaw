...
use brassclaw_loop_support::{BudgetSeedingPolicy, GovernorBackedAccountant, ModelCostTable};
...
use brassclaw_turns::run_profile::LoopModelBudgetAccountant;
...
mod tests {
    use super::*;
    use brassclaw_host_api::{InvocationId, ResourceEstimate, ResourceScope, TenantId, UserId};
    use brassclaw_loop_support::ZeroCostTable;
    use brassclaw_resources::{
    ...
    async fn seeds_compiled_default_user_cap_on_first_touch() {
        ...
        let request = brassclaw_turns::run_profile::LoopModelRequest {
            messages: vec![],
    ...
    fn test_run_context(tenant: &str, user: &str) -> brassclaw_turns::run_profile::LoopRunContext {
