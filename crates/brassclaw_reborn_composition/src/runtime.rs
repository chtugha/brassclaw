...
async fn fold_legacy_webui_identities<R>(
    ...
    tenant_id: &TenantId,
    store: &R,
) -> Result<(), brassclaw_reborn_identity::RebornIdentityError>
where
    R: brassclaw_reborn_identity::RebornIdentityResolver + ?Sized,
{
    ...
    fn invalid_key(error: brassclaw_reborn_identity::IdentityKeyError) -> RebornIdentityError {
        RebornIdentityError::Backend(error.to_string())
    }
...
impl RebornRuntime {
    ...
    > {
        ...
        let store = brassclaw_reborn_identity::FilesystemRebornIdentityStore::new(
