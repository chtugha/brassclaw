...
use brassclaw_filesystem::{FileType, FilesystemError, RootFilesystem};
use brassclaw_host_api::{CapabilityId, ExtensionId, VirtualPath, sha256_digest_token};
...
const NOTION_MCP_MANIFEST: &str =
    include_str!("../../brassclaw_first_party_extensions/assets/notion-mcp/manifest.toml");
const WEB_ACCESS_MANIFEST: &str =
    include_str!("../../brassclaw_first_party_extensions/assets/web-access/manifest.toml");
const NEARAI_MCP_MANIFEST: &str =
    include_str!("../../brassclaw_first_party_extensions/assets/nearai-mcp/manifest.toml");
...
fn onboarding(package_id: &str) -> Option<LifecycleExtensionOnboarding> {
    match package_id {
        ...
        "google-calendar" => Some(onboarding_message(
            ...
            Some("Authorize the Google account that BrassClaw should use for calendar events."),
            None,
        ...
        "notion" => Some(onboarding_message(
            ...
            Some("Authorize the Notion workspace that BrassClaw should access for MCP requests."),
            None,
        ...
        "nearai" => Some(onboarding_message(
            ...
            Some("Paste the NEAR AI API key BrassClaw should use for hosted MCP requests."),
            None,
...
fn credential_requirements(
    ...
    for capability in &package.package.manifest.capabilities {
        for requirement in &capability.runtime_credentials {
            let brassclaw_host_api::RuntimeCredentialRequirementSource::ProductAuthAccount {
                provider,
                setup,
            } = &requirement.source
            else {
...
fn credential_setup(
    setup: &brassclaw_host_api::RuntimeCredentialAccountSetup,
) -> LifecycleExtensionCredentialSetup {
    match setup {
        brassclaw_host_api::RuntimeCredentialAccountSetup::ManualToken => {
            LifecycleExtensionCredentialSetup::ManualToken
        }
        brassclaw_host_api::RuntimeCredentialAccountSetup::OAuth { scopes } => {
...
fn bundled_extension_package(
    ...
    let host_ports = brassclaw_host_runtime::default_host_port_catalog().map_err(|error| {
        ProductWorkflowError::InvalidBindingRequest {
            reason: format!("host port catalog rejected bundled {label} extension: {error}"),
        }
    })?;
    let contracts =
        brassclaw_host_runtime::default_host_api_contract_registry().map_err(|error| {
            ProductWorkflowError::InvalidBindingRequest {
        ...
        ($path:literal) => {
            bytes_asset(
                ...
                include_bytes!(concat!(
                    "../../brassclaw_first_party_extensions/assets/notion-mcp/schemas/notion/",
                    $path
                )),
            )
        };
    ...
    macro_rules! notion_prompt_asset {
        ($path:literal) => {
            bytes_asset(
                ...
                include_bytes!(concat!(
                    "../../brassclaw_first_party_extensions/assets/notion-mcp/prompts/notion/",
                    $path
                )),
            )
        };
...
fn web_access_assets() -> Vec<AvailableExtensionAsset> {
    vec![
        ...
        bytes_asset(
            ...
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/web-access/schemas/web-access/search.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/web-access/search.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/web-access/schemas/web-access/search.output.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/web-access/get_content.input.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/web-access/schemas/web-access/get_content.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/web-access/get_content.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/web-access/schemas/web-access/get_content.output.v1.json"
            ),
        ),
        bytes_asset(
            "prompts/web-access/search.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/web-access/prompts/web-access/search.md"
            ),
        ),
        bytes_asset(
            "prompts/web-access/get_content.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/web-access/prompts/web-access/get_content.md"
            ),
        ),
    ]
}
...
fn nearai_mcp_assets(manifest: &str) -> Vec<AvailableExtensionAsset> {
    vec![
        ...
        bytes_asset(
            ...
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/nearai-mcp/schemas/nearai/search.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/nearai/search.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/nearai-mcp/schemas/nearai/search.output.v1.json"
            ),
        ),
        bytes_asset(
            "prompts/nearai/search.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/nearai-mcp/prompts/nearai/search.md"
            ),
        ),
    ]
}
...
fn google_calendar_assets() -> Vec<AvailableExtensionAsset> {
    vec![
        ...
        bytes_asset(
            ...
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/list_calendars.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/list_calendars.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/list_calendars.output.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/list_events.input.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/list_events.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/list_events.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/list_events.output.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/get_event.input.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/get_event.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/get_event.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/get_event.output.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/find_free_slots.input.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/find_free_slots.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/find_free_slots.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/find_free_slots.output.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/create_event.input.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/create_event.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/create_event.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/create_event.output.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/update_event.input.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/update_event.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/update_event.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/update_event.output.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/delete_event.input.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/delete_event.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/delete_event.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/delete_event.output.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/add_attendees.input.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/add_attendees.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/add_attendees.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/add_attendees.output.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/set_reminder.input.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/set_reminder.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/google-calendar/set_reminder.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/schemas/google-calendar/set_reminder.output.v1.json"
            ),
        ),
        bytes_asset(
            "prompts/google-calendar/list_calendars.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/prompts/google-calendar/list_calendars.md"
            ),
        ),
        bytes_asset(
            "prompts/google-calendar/list_events.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/prompts/google-calendar/list_events.md"
            ),
        ),
        bytes_asset(
            "prompts/google-calendar/get_event.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/prompts/google-calendar/get_event.md"
            ),
        ),
        bytes_asset(
            "prompts/google-calendar/find_free_slots.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/prompts/google-calendar/find_free_slots.md"
            ),
        ),
        bytes_asset(
            "prompts/google-calendar/create_event.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/prompts/google-calendar/create_event.md"
            ),
        ),
        bytes_asset(
            "prompts/google-calendar/update_event.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/prompts/google-calendar/update_event.md"
            ),
        ),
        bytes_asset(
            "prompts/google-calendar/delete_event.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/prompts/google-calendar/delete_event.md"
            ),
        ),
        bytes_asset(
            "prompts/google-calendar/add_attendees.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/prompts/google-calendar/add_attendees.md"
            ),
        ),
        bytes_asset(
            "prompts/google-calendar/set_reminder.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/google-calendar/prompts/google-calendar/set_reminder.md"
            ),
        ),
    ]
}
...
fn gmail_assets() -> Vec<AvailableExtensionAsset> {
    vec![
        ...
        bytes_asset(
            ...
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/schemas/gmail/list_messages.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/gmail/list_messages.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/schemas/gmail/list_messages.output.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/gmail/get_message.input.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/schemas/gmail/get_message.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/gmail/get_message.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/schemas/gmail/get_message.output.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/gmail/send_message.input.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/schemas/gmail/send_message.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/gmail/send_message.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/schemas/gmail/send_message.output.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/gmail/create_draft.input.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/schemas/gmail/create_draft.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/gmail/create_draft.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/schemas/gmail/create_draft.output.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/gmail/reply_to_message.input.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/schemas/gmail/reply_to_message.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/gmail/reply_to_message.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/schemas/gmail/reply_to_message.output.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/gmail/trash_message.input.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/schemas/gmail/trash_message.input.v1.json"
            ),
        ),
        bytes_asset(
            "schemas/gmail/trash_message.output.v1.json",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/schemas/gmail/trash_message.output.v1.json"
            ),
        ),
        bytes_asset(
            "prompts/gmail/list_messages.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/prompts/gmail/list_messages.md"
            ),
        ),
        bytes_asset(
            "prompts/gmail/get_message.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/prompts/gmail/get_message.md"
            ),
        ),
        bytes_asset(
            "prompts/gmail/send_message.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/prompts/gmail/send_message.md"
            ),
        ),
        bytes_asset(
            "prompts/gmail/create_draft.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/prompts/gmail/create_draft.md"
            ),
        ),
        bytes_asset(
            "prompts/gmail/reply_to_message.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/prompts/gmail/reply_to_message.md"
            ),
        ),
        bytes_asset(
            "prompts/gmail/trash_message.md",
            include_bytes!(
                "../../brassclaw_first_party_extensions/assets/gmail/prompts/gmail/trash_message.md"
            ),
        ),
    ]
}
...
mod tests {
    ...
    use brassclaw_extensions::{ExtensionManifest, ManifestSource};
