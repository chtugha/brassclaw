...
///
/// `reborn_home` is the resolved Reborn state root (same value passed to
/// `build_reborn_runtime`).  The prompt path is derived from it exactly as
/// the local-dev path does.
#[cfg(feature = "postgres")]
