...
#[cfg(test)]
mod tests {
    use brassclaw_extensions::{ExtensionManifest, ExtensionPackage, ManifestSource};
    use brassclaw_host_api::{
    ...
    fn registry_with_notion() -> brassclaw_extensions::ExtensionRegistry {
    ...
    ) -> brassclaw_extensions::ExtensionRegistry {
        let mut registry = brassclaw_extensions::ExtensionRegistry::new();
        ...
        registry
            .insert(
                ExtensionPackage::from_manifest(
                    ExtensionManifest {
                        schema_version: brassclaw_extensions::MANIFEST_SCHEMA_VERSION.to_string(),
                        id: ExtensionId::new(provider).unwrap(),
                        name: provider.to_string(),
                        version: "0.1.0".to_string(),
                        description: "Hosted MCP".to_string(),
                        source: ManifestSource::HostBundled,
                        requested_trust: brassclaw_host_api::RequestedTrustClass::ThirdParty,
                        descriptor_trust_default: TrustClass::Sandbox,
                        runtime: brassclaw_extensions::ExtensionRuntime::Mcp {
                        ...
                        host_apis: Vec::new(),
                        hooks: Vec::new(),
                        capabilities: vec![brassclaw_extensions::CapabilityManifest {
                            ...
                            effects: vec![
                                ...
                                brassclaw_host_api::EffectKind::UseSecret,
                            ],
                            default_permission: PermissionMode::Allow,
                            visibility: brassclaw_extensions::CapabilityVisibility::Model,
                            ...
                            runtime_credentials: vec![
                                brassclaw_host_api::RuntimeCredentialRequirement {
