...
use brassclaw_host_api::InvocationId;
use brassclaw_loop_support::CapabilityResultWrite;
...
fn skill_activation_host_error(
    error: brassclaw_first_party_extension_ports::SkillActivationSelectionError,
) -> AgentLoopHostError {
    let kind = match error {
        brassclaw_first_party_extension_ports::SkillActivationSelectionError::AmbiguousSkill {
            ..
        }
        ...
        brassclaw_first_party_extension_ports::SkillActivationSelectionError::ContextBudgetExceeded => {
            AgentLoopHostErrorKind::BudgetExceeded
        }
        brassclaw_first_party_extension_ports::SkillActivationSelectionError::SourceUnavailable => {
            AgentLoopHostErrorKind::Unavailable
        }
        brassclaw_first_party_extension_ports::SkillActivationSelectionError::Internal => {
