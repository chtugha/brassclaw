...
use brassclaw_product_workflow::ProductWorkflowError;
...
mod tests {
    use super::*;
    use brassclaw_first_party_extensions::google_api_network_policy;
    ...
    fn web_access_search_deduplicates_existing_exa_mcp_network_target() {
        let capability = ActiveExtensionCapability {
            ...
            provider: ExtensionId::new(WEB_ACCESS_EXTENSION_ID).unwrap(),
            effects: vec![EffectKind::DispatchCapability, EffectKind::Network],
            runtime_credentials: vec![brassclaw_host_api::RuntimeCredentialRequirement {
                handle: brassclaw_host_api::SecretHandle::new("exa_mcp_token").unwrap(),
                source: brassclaw_host_api::RuntimeCredentialRequirementSource::SecretHandle,
                ...
                target: brassclaw_host_api::RuntimeCredentialTarget::Header {
    ...
    fn gsuite_capabilities_get_google_api_network_policy() {
        let capability = ActiveExtensionCapability {
            ...
            provider: ExtensionId::new(brassclaw_first_party_extensions::GMAIL_EXTENSION_ID)
                .unwrap(),
            effects: vec![
    ...
    fn calendar_capability_gets_google_api_network_policy() {
        let capability = ActiveExtensionCapability {
            ...
            provider: ExtensionId::new(brassclaw_first_party_extensions::CALENDAR_EXTENSION_ID)
                .unwrap(),
            effects: vec![
                EffectKind::DispatchCapability,
                EffectKind::Network,
