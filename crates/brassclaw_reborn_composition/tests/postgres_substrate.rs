...
async fn postgres_substrate_builder_wires_production_components_without_local_only_seams() {
    ...
    let services =
        build_postgres_production_host_runtime_services(PostgresProductionSubstrateConfig {
            ...
            trust_policy: Arc::new(brassclaw_trust::HostTrustPolicy::fail_closed()),
...
fn sandbox_process_port() -> Arc<brassclaw_host_runtime::TenantSandboxProcessPort> {
    Arc::new(brassclaw_host_runtime::TenantSandboxProcessPort::new(
