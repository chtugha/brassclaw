...
use brassclaw_extensions::{ExtensionRuntime, ManifestSource};
...
use brassclaw_host_runtime::FirstPartyCapabilityRequest;
...
fn asset_manifest(extension_id: &str) -> brassclaw_extensions::ExtensionManifest {
    ...
    brassclaw_extensions::ExtensionManifest::parse(
        ...
        &brassclaw_host_api::HostPortCatalog::empty(),
    )
    .unwrap()
}
            ...
            .map(|capability| {
                ...
                (
                    ...
                    vec![(
                        ...
                        brassclaw_auth::GOOGLE_PROVIDER_ID.to_string(),
...
async fn bundled_gsuite_handler_projects_stage_auth_required_to_first_party_auth_required() {
    ...
    assert_eq!(
        ...
        brassclaw_auth::GOOGLE_PROVIDER_ID
    );
