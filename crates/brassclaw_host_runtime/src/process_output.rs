...
const COMMAND_OUTPUT_TEMP_PREFIX: &str = "brassclaw-command-output-";
const COMMAND_OUTPUT_SCRATCH_PREFIX: &str = "brassclaw-command-output-scratch-";
...
const COMMAND_OUTPUT_ROOT_DIRNAME: &str = "brassclaw-command-outputs";
...
/// scope's saved-output files. The path layout — `<tempdir>/brassclaw-command-
...
mod tests {
    use super::*;
    use brassclaw_host_api::{InvocationId, ResourceScope, UserId};
