    ...
    R: ProcessResultStore + 'static,
{
    ...
    /// [`RootFilesystem`](brassclaw_filesystem::RootFilesystem); see
    ...
    /// `brassclaw_capabilities::host`. Production composition should layer a
    ...
    /// `brassclaw_reborn_event_store`, then this method adapts the durable logs
