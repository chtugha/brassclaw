...
impl ResourceGovernor for ReconcileFailingGovernor {
    fn set_limit(
        ...
        limits: brassclaw_resources::ResourceLimits,
    ...
    fn reserve_with_outcome(
        ...
        estimate: brassclaw_host_api::ResourceEstimate,
    ) -> Result<brassclaw_resources::ReservationOutcome, brassclaw_resources::ResourceError> {
    ...
    fn reserve_with_id_and_outcome(
        ...
        scope: brassclaw_host_api::ResourceScope,
        estimate: brassclaw_host_api::ResourceEstimate,
        reservation_id: brassclaw_host_api::ResourceReservationId,
    ) -> Result<brassclaw_resources::ReservationOutcome, brassclaw_resources::ResourceError> {
        self.inner
    ...
    fn reconcile(
        &self,
        reservation_id: brassclaw_host_api::ResourceReservationId,
        _actual: brassclaw_host_api::ResourceUsage,
    ) -> Result<brassclaw_host_api::ResourceReceipt, brassclaw_resources::ResourceError> {
        Err(brassclaw_resources::ResourceError::UnknownReservation { id: reservation_id })
    }
    ...
    fn account_snapshot(
        &self,
        account: &ResourceAccount,
    ) -> Result<Option<brassclaw_resources::AccountSnapshot>, brassclaw_resources::ResourceError>
    {
...
impl crate::FirstPartyCapabilityHandler for SucceedingFirstPartyHandler {
    async fn dispatch(
        ...
        Ok(crate::FirstPartyCapabilityResult {
            ...
            usage: brassclaw_host_api::ResourceUsage::default(),
        })
    }
}
