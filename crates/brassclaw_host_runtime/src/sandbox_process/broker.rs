...
use brassclaw_safety::params_contain_manual_credentials;

use crate::RuntimeProcessError;

use super::reject_nul;

const REBORN_NETWORK_MODE_ENV: &str = "BRASSCLAW_REBORN_NETWORK_MODE";
const REBORN_HTTP_PROXY_ENV: &str = "BRASSCLAW_REBORN_HTTP_PROXY";
const REBORN_HTTP_BROKER_SOCKET_ENV: &str = "BRASSCLAW_REBORN_HTTP_BROKER_SOCKET";
const REBORN_HTTP_BROKER_URL_ENV: &str = "BRASSCLAW_REBORN_HTTP_BROKER_URL";
const REBORN_SECRET_MODE_ENV: &str = "BRASSCLAW_REBORN_SECRET_MODE";
const REBORN_SECRET_BROKER_ENV: &str = "BRASSCLAW_REBORN_SECRET_BROKER_URL";
const REBORN_SECRET_BROKER_SOCKET_ENV: &str = "BRASSCLAW_REBORN_SECRET_BROKER_SOCKET";
...
const CONTAINER_HTTP_BROKER_SOCKET: &str = "/tmp/brassclaw-http-broker.sock";
const CONTAINER_SECRET_BROKER_SOCKET: &str = "/tmp/brassclaw-secret-broker.sock";
const CONTAINER_BROKER_URL: &str = "http://brassclaw-broker";
