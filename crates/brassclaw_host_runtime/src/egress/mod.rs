...
use brassclaw_network::{NetworkHttpEgress, NetworkHttpError};
...
pub(super) fn runtime_response(
    response: brassclaw_network::NetworkHttpResponse,
    redaction_applied: bool,
    saved_body: Option<brassclaw_host_api::RuntimeHttpSavedBody>,
