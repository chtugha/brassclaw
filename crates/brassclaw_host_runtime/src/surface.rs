...
use brassclaw_extensions::{CapabilityVisibility, ExtensionPackage, ExtensionRegistry};
...
fn host_api_error(error: brassclaw_host_api::HostApiError) -> HostRuntimeError {
