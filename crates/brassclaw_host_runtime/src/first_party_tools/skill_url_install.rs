...
const MAX_ZIP_ENTRY_BYTES: u64 = brassclaw_skills::MAX_INSTALL_BUNDLE_FILE_BYTES as u64;
const MAX_TOTAL_UNZIPPED_BYTES: u64 = brassclaw_skills::MAX_INSTALL_BUNDLE_TOTAL_BYTES as u64;
...
const MAX_ZIP_FILE_ENTRIES: usize = brassclaw_skills::MAX_INSTALL_BUNDLE_FILES * 4;
