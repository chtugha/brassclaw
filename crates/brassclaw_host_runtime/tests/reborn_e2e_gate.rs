...
use brassclaw_resources::{InMemoryResourceGovernor, ResourceAccount, ResourceTally};
...
async fn reborn_e2e_gate_host_http_consumes_staged_policy_and_secret_once() {
    ...
    obligation_services
        .obligation_handler()
        .satisfy(brassclaw_capabilities::CapabilityObligationRequest {
            phase: brassclaw_capabilities::CapabilityObligationPhase::Invoke,
            context: &context,
