...
use brassclaw_host_runtime::{
    APPLY_PATCH_CAPABILITY_ID, COMPONENT_DB_CAPABILITY_ID, CapabilitySurfacePolicy,
    ...
    MEMORY_WRITE_CAPABILITY_ID, READ_FILE_CAPABILITY_ID, RuntimeCapabilityFailure,
...
use brassclaw_resources::{InMemoryResourceGovernor, ResourceAccount};
...
async fn builtin_shell_maps_timeout_and_spawn_failures() {
    ...
    let spawn = invoke_shell(json!({
            ...
            "workdir": "/definitely/missing/brassclaw-shell-test"
    }))
    .await
    .unwrap_err();
...
async fn builtin_shell_does_not_inherit_unlisted_parent_env() {
    ...
    unsafe {
        std::env::set_var("BRASSCLAW_SHELL_SECRET_TEST", "must_not_leak");
    }
    let output = invoke_shell(json!({
        "command": "printf ${BRASSCLAW_SHELL_SECRET_TEST:-missing}"
    }))
    .await;
    // SAFETY: clears only the test-owned key set above.
    unsafe {
        std::env::remove_var("BRASSCLAW_SHELL_SECRET_TEST");
    }
...
async fn builtin_skill_install_url_path_rejects_invalid_zip_bundles() {
    ...
    let too_many_entries = (0..(brassclaw_skills::MAX_INSTALL_BUNDLE_FILES * 4 + 1))
        .map(|index| (format!("bundle/empty-{index}.txt"), Vec::new()))
        .collect::<Vec<_>>();
    let too_many_directories = (0..(brassclaw_skills::MAX_INSTALL_BUNDLE_FILES * 4 + 1))
...
fn trigger_backend_error() -> brassclaw_triggers::TriggerError {
    brassclaw_triggers::TriggerError::Backend {
...
impl TriggerRepository for RemoveFailingTriggerRepository {
    async fn upsert_trigger(
        &self,
        record: brassclaw_triggers::TriggerRecord,
    ) -> Result<(), brassclaw_triggers::TriggerError> {
    ...
    async fn list_triggers(
        &self,
        tenant_id: TenantId,
    ) -> Result<Vec<brassclaw_triggers::TriggerRecord>, brassclaw_triggers::TriggerError> {
    ...
    async fn list_active_triggers_after(
        &self,
        after: Option<brassclaw_triggers::ActiveTriggerScanCursor>,
        limit: usize,
    ) -> Result<Vec<brassclaw_triggers::TriggerRecord>, brassclaw_triggers::TriggerError> {
    ...
    async fn claim_due_fire(
        &self,
        request: brassclaw_triggers::ClaimDueFireRequest,
    ) -> Result<brassclaw_triggers::ClaimDueFireOutcome, brassclaw_triggers::TriggerError> {
        self.inner.claim_due_fire(request).await
    }

    async fn mark_fire_accepted(
        &self,
        request: brassclaw_triggers::FireAcceptedRequest,
    ) -> Result<Option<brassclaw_triggers::TriggerRecord>, brassclaw_triggers::TriggerError> {
    ...
    async fn mark_fire_replayed(
        &self,
        request: brassclaw_triggers::FireReplayedRequest,
    ) -> Result<Option<brassclaw_triggers::TriggerRecord>, brassclaw_triggers::TriggerError> {
    ...
    async fn mark_fire_retryable_failed(
        &self,
        request: brassclaw_triggers::FireRetryableFailedRequest,
    ) -> Result<Option<brassclaw_triggers::TriggerRecord>, brassclaw_triggers::TriggerError> {
    ...
    async fn mark_fire_permanently_failed(
        &self,
        request: brassclaw_triggers::FirePermanentFailedRequest,
    ) -> Result<Option<brassclaw_triggers::TriggerRecord>, brassclaw_triggers::TriggerError> {
    ...
    async fn mark_fire_terminally_failed(
        &self,
        request: brassclaw_triggers::FireTerminalFailedRequest,
    ) -> Result<Option<brassclaw_triggers::TriggerRecord>, brassclaw_triggers::TriggerError> {
    ...
    async fn clear_active_fire(
        &self,
        request: brassclaw_triggers::ClearActiveFireRequest,
    ) -> Result<Option<brassclaw_triggers::TriggerRecord>, brassclaw_triggers::TriggerError> {
...
impl TriggerRepository for FailingTriggerRepository {
    async fn upsert_trigger(
        &self,
        _record: brassclaw_triggers::TriggerRecord,
    ) -> Result<(), brassclaw_triggers::TriggerError> {
        Err(trigger_backend_error())
    }
    ...
    async fn list_active_triggers_after(
        &self,
        _after: Option<brassclaw_triggers::ActiveTriggerScanCursor>,
        _limit: usize,
    ) -> Result<Vec<brassclaw_triggers::TriggerRecord>, brassclaw_triggers::TriggerError> {
        unreachable!("failing test repository does not list active triggers")
    }
    ...
    async fn claim_due_fire(
        &self,
        _request: brassclaw_triggers::ClaimDueFireRequest,
    ) -> Result<brassclaw_triggers::ClaimDueFireOutcome, brassclaw_triggers::TriggerError> {
    ...
    async fn mark_fire_accepted(
        &self,
        _request: brassclaw_triggers::FireAcceptedRequest,
    ) -> Result<Option<brassclaw_triggers::TriggerRecord>, brassclaw_triggers::TriggerError> {
    ...
    async fn mark_fire_replayed(
        &self,
        _request: brassclaw_triggers::FireReplayedRequest,
    ) -> Result<Option<brassclaw_triggers::TriggerRecord>, brassclaw_triggers::TriggerError> {
        unreachable!("failing test repository does not update fire results")
    }
    ...
    async fn mark_fire_retryable_failed(
        &self,
        _request: brassclaw_triggers::FireRetryableFailedRequest,
    ) -> Result<Option<brassclaw_triggers::TriggerRecord>, brassclaw_triggers::TriggerError> {
        unreachable!("failing test repository does not update fire results")
    }
    ...
    async fn mark_fire_permanently_failed(
        &self,
        _request: brassclaw_triggers::FirePermanentFailedRequest,
    ) -> Result<Option<brassclaw_triggers::TriggerRecord>, brassclaw_triggers::TriggerError> {
        unreachable!("failing test repository does not update fire results")
    }
    ...
    async fn mark_fire_terminally_failed(
        &self,
        _request: brassclaw_triggers::FireTerminalFailedRequest,
    ) -> Result<Option<brassclaw_triggers::TriggerRecord>, brassclaw_triggers::TriggerError> {
        unreachable!("failing test repository does not update fire results")
    }
