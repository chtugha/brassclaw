...
use brassclaw_skills::v2::{CodeSnippet, SkillRepairRecord, SkillRepairType, V2SkillMetadata};
...
impl MissionManager {
    ...
    pub async fn resume_paused_for_credential(
        &self,
        credential_name: &brassclaw_common::CredentialName,
        user_id: &str,
...
mod tests {
    ...
    fn build_skill_gap_payload_skips_read_only_shell_workflows() {
        ...
        thread.add_event(crate::types::event::EventKind::ActionExecuted {
            ...
            action_name: "shell".to_string(),
            call_id: "call_1".to_string(),
            params_summary: Some("gh pr list --repo chtugha/brassclaw".to_string()),
            duration_ms: 15,
        });
    ...
    fn threads_today_is_stale_predicate() {
        ...
        let tz = brassclaw_common::ValidTimezone::parse("Pacific/Auckland").unwrap();
