//! Docker process sandbox process executor for BrassClaw Reborn.
//!
...
pub const DEFAULT_PROCESS_SANDBOX_IMAGE: &str = "brassclaw-process-sandbox:dev";
pub const PROCESS_SANDBOX_CAPABILITY_ID: &str = "system.process_sandbox.run";
pub const DEFAULT_WORKSPACE_MOUNT: &str = "/workspace";
pub const DEFAULT_TOOLS_MOUNT: &str = "/brassclaw/state/tools";
pub const DEFAULT_CACHE_MOUNT: &str = "/brassclaw/state/cache";
