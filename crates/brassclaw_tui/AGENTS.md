...
- `crates/brassclaw_tui/CLAUDE.md`
...
- Fast local check: `cargo test -p brassclaw_tui`
...
- Keep the crate independent from the main `brassclaw` crate; bridge integration belongs in `src/channels/tui.rs`.
