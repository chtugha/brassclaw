...
mod tests {
    ...
    fn test_system_event_trigger_roundtrip() {
        ...
        filters.insert("repo".to_string(), "chtugha/brassclaw".to_string());
    ...
    fn test_system_event_fingerprint_is_stable_when_filter_insertion_order_differs() {
        ...
        first_filters.insert("repo".to_string(), "chtugha/brassclaw".to_string());
        ...
        second_filters.insert("repo".to_string(), "chtugha/brassclaw".to_string());
