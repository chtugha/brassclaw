...
//!
//! `status` (runtime health) requires connecting to a running BrassClaw instance
...
async fn cmd_list(
    ...
    if !verbose {
        ...
        println!("managed via environment variables. See 'brassclaw onboard --channels-only'.");
    }
