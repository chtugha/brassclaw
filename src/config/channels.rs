...
pub struct ChannelsConfig {
    ...
    /// Reborn Telegram WASM v2 ProductAdapter (#3285) flag.
    ///
    /// V2 Reborn architecture for Telegram integration.
...
// V1 WASM channel validation removed - no longer needed after V1 deletion
