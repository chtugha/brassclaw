...
pub struct SkillsConfig {
    ...
    pub enabled: bool,
    /// Directory containing user-placed skills (default: ~/.brassclaw/skills/).
    /// Skills here are loaded with `Trusted` trust level.
    pub local_dir: PathBuf,
    /// Directory containing registry-installed skills (default: ~/.brassclaw/installed_skills/).
...
/// Get the default user skills directory (~/.brassclaw/skills/).
fn default_skills_dir() -> PathBuf {
    brassclaw_base_dir().join("skills")
}

/// Get the default installed skills directory (~/.brassclaw/installed_skills/).
fn default_installed_skills_dir() -> PathBuf {
    brassclaw_base_dir().join("installed_skills")
}
