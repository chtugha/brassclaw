...
pub(super) async fn setup_signal(
    _settings: &Settings,
) -> Result<SignalSetupResult, ChannelSetupError> {
...
mod tests {
    ...
    use crate::setup::channels::{
        generate_webhook_secret, http_webhook_secret_hint, validate_cloudflare_token_format,
    };
